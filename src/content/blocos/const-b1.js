/**
 * Direito Constitucional — bloco único
 */
export default {
  id: 'const-b1',
  materiaId: 'const',
  nome: 'Bloco único — Direitos fundamentais e Administração Pública',
  ordem: 1,
  objetivo: 'Direitos e garantias, direitos sociais, nacionalidade e arts. 37 a 41 da CF/88.',
  topicos: [
    {
      id: 'const-b1-01',
...
`,
      questoes: [
        { id: 'const-b1-01-q1', enunciado: 'A obtenção de certidões em repartições públicas, para esclarecimento de situação de interesse pessoal, é direito assegurado a todos e independe do pagamento de taxa.', certa: true, explicacao: 'Literalidade do art. 5º, XXXIV, "b", da CF/88. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 5º, XXXIV, "b"', variacoes: [{ enunciado: 'O direito de petição aos poderes públicos em defesa de direitos depende do recolhimento de taxa específica.', certa: false, explicacao: 'O art. 5º, XXXIV, "a", assegura o direito de petição independentemente do pagamento de taxas.' }] },
        { id: 'const-b1-01-q2', enunciado: 'Os direitos fundamentais possuem caráter absoluto, não admitindo qualquer relativização.', certa: false, explicacao: 'A relatividade é característica dos direitos fundamentais: eles podem ser limitados diante de outros direitos. Nem mesmo o direito à vida é absoluto (pena de morte em guerra declarada).', baseLegal: 'CF/88, art. 5º, XLVII, "a"', variacoes: [{ enunciado: 'As normas definidoras dos direitos e garantias fundamentais têm aplicação imediata.', certa: true, explicacao: 'Correto — art. 5º, §1º, da CF/88.' }] },
        { id: 'const-b1-01-q3', enunciado: 'A casa é asilo inviolável do indivíduo, sendo permitida a entrada sem consentimento do morador, durante o dia, por determinação judicial.', certa: true, explicacao: 'Art. 5º, XI. Em flagrante delito, desastre ou para prestar socorro, a entrada é possível a qualquer hora, inclusive à noite.', baseLegal: 'CF/88, art. 5º, XI', variacoes: [{ enunciado: 'A interceptação das comunicações telefônicas pode ser determinada por autoridade policial, independentemente de ordem judicial, em investigação criminal.', certa: false, explicacao: 'A interceptação exige ORDEM JUDICIAL, nas hipóteses e na forma da lei (art. 5º, XII).' }] },
        { id: 'const-b1-01-q4', enunciado: 'Os tratados internacionais sobre direitos humanos aprovados em cada Casa do Congresso Nacional, em dois turnos, por três quintos dos votos, equivalem às emendas constitucionais.', certa: true, explicacao: 'É o rito do art. 5º, §3º. Fora dele, o STF confere status supralegal aos tratados de direitos humanos.', baseLegal: 'CF/88, art. 5º, §3º', variacoes: [{ enunciado: 'Os direitos e garantias fundamentais são assegurados exclusivamente a brasileiros e a estrangeiros residentes no país, sendo inaplicáveis a pessoas jurídicas.', certa: false, explicacao: 'O STF interpreta o caput de forma ampliativa: alcança estrangeiros não residentes, apátridas e pessoas jurídicas, no que for compatível.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'const-b1-02',
      nome: 'Direito à vida, liberdade, igualdade, segurança e propriedade',
      teoria: `
...
`,
      questoes: [
        { id: 'const-b1-02-q1', enunciado: 'O Poder Judiciário pode determinar a implantação de políticas públicas relacionadas a direitos e garantias fundamentais, sem que isso ofenda o princípio da separação dos poderes.', certa: true, explicacao: 'Entendimento consolidado do STF diante de omissão do Poder Público na efetivação de direitos fundamentais. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 5º, §1º; STF, RE 592.581', variacoes: [{ enunciado: 'A determinação judicial de implementação de políticas públicas configura sempre indevida interferência na discricionariedade administrativa.', certa: false, explicacao: 'O STF admite a intervenção diante de omissão que comprometa direitos fundamentais.' }] },
        { id: 'const-b1-02-q2', enunciado: 'A reunião pacífica em locais abertos ao público depende de prévia autorização da autoridade competente.', certa: false, explicacao: 'Exige-se apenas PRÉVIO AVISO à autoridade, e não autorização — desde que não frustre outra reunião no mesmo local.', baseLegal: 'CF/88, art. 5º, XVI', variacoes: [{ enunciado: 'A criação de associações independe de autorização, sendo vedada a interferência estatal em seu funcionamento.', certa: true, explicacao: 'Correto — art. 5º, XVIII, da CF/88.' }] },
        { id: 'const-b1-02-q3', enunciado: 'A desapropriação por necessidade ou utilidade pública exige justa e prévia indenização em dinheiro, ressalvados os casos previstos na Constituição.', certa: true, explicacao: 'Art. 5º, XXIV. As exceções são a desapropriação-sanção por descumprimento da função social (títulos da dívida) e a confiscatória.', baseLegal: 'CF/88, art. 5º, XXIV', variacoes: [{ enunciado: 'Em caso de iminente perigo público, a autoridade competente pode usar propriedade particular, assegurada indenização prévia ao proprietário.', certa: false, explicacao: 'Na requisição, a indenização é ULTERIOR e apenas se houver dano (art. 5º, XXV).' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'const-b1-03-q1', enunciado: 'O Fundo de Garantia do Tempo de Serviço é direito tanto dos trabalhadores urbanos quanto dos rurais.', certa: true, explicacao: 'O caput do art. 7º equipara urbanos e rurais, e o inciso III arrola o FGTS. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 7º, caput e III', variacoes: [{ enunciado: 'Os direitos previstos no art. 7º da Constituição aplicam-se exclusivamente aos trabalhadores urbanos.', certa: false, explicacao: 'O caput é expresso ao alcançar trabalhadores urbanos E rurais.' }] },
        { id: 'const-b1-03-q2', enunciado: 'A participação dos sindicatos nas negociações coletivas de trabalho pode ser dispensada mediante manifestação da maioria dos filiados.', certa: false, explicacao: 'O art. 8º, VI, torna OBRIGATÓRIA a participação dos sindicatos nas negociações coletivas, sem previsão de dispensa. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 8º, VI', variacoes: [{ enunciado: 'É vedada a criação de mais de uma organização sindical representativa de categoria profissional na mesma base territorial.', certa: true, explicacao: 'Correto — é a unicidade sindical do art. 8º, II, cuja base não pode ser inferior a um Município.' }] },
        { id: 'const-b1-03-q3', enunciado: 'É assegurada igualdade de direitos entre o trabalhador com vínculo empregatício permanente e o trabalhador avulso.', certa: true, explicacao: 'Art. 7º, XXXIV — equiparação constitucional expressa, relevante também para o Direito Previdenciário.', baseLegal: 'CF/88, art. 7º, XXXIV', variacoes: [{ enunciado: 'A proibição de trabalho noturno, perigoso ou insalubre alcança os menores de dezoito anos, e o trabalho em geral, os menores de dezesseis, salvo na condição de aprendiz a partir dos quatorze.', certa: true, explicacao: 'Correto — art. 7º, XXXIII, da CF/88.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'const-b1-04',
      nome: 'Nacionalidade e cidadania',
      teoria: `
...
`,
      questoes: [
        { id: 'const-b1-04-q1', enunciado: 'A nacionalidade brasileira será concedida de ofício aos estrangeiros de qualquer nacionalidade que residam no Brasil há mais de quinze anos e que não possuam condenação penal.', certa: false, explicacao: 'A naturalização extraordinária exige REQUERIMENTO do interessado, além dos 15 anos ininterruptos e da ausência de condenação penal. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 12, II, "b"', variacoes: [{ enunciado: 'A naturalização extraordinária exige residência ininterrupta por mais de quinze anos, ausência de condenação penal e requerimento do interessado.', certa: true, explicacao: 'Correto — são os três requisitos cumulativos do art. 12, II, "b".' }] },
        { id: 'const-b1-04-q2', enunciado: 'No caso de senador que pretenda concorrer a outro cargo eletivo, não se exige a renúncia ao mandato atual.', certa: true, explicacao: 'A desincompatibilização por renúncia (6 meses antes) alcança apenas os chefes do Executivo. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 14, §6º', variacoes: [{ enunciado: 'O Governador que pretenda concorrer a outro cargo deve renunciar ao mandato até seis meses antes do pleito.', certa: true, explicacao: 'Correto — art. 14, §6º, aplicável a Presidente, Governadores e Prefeitos.' }] },
        { id: 'const-b1-04-q3', enunciado: 'São privativos de brasileiro nato os cargos de Ministro do Supremo Tribunal Federal, de Presidente da Câmara dos Deputados e de oficial das Forças Armadas.', certa: true, explicacao: 'Integram o rol taxativo do art. 12, §3º (mnemônico MP3.COM).', baseLegal: 'CF/88, art. 12, §3º', variacoes: [{ enunciado: 'O cargo de Ministro de Estado da Justiça é privativo de brasileiro nato.', certa: false, explicacao: 'Apenas o Ministro de Estado da DEFESA integra o rol do art. 12, §3º.' }] },
        { id: 'const-b1-04-q4', enunciado: 'O alistamento eleitoral e o voto são facultativos para os maiores de setenta anos e para os analfabetos.', certa: true, explicacao: 'Art. 14, §1º, II. Também é facultativo para maiores de 16 e menores de 18 anos.', baseLegal: 'CF/88, art. 14, §1º, II', variacoes: [{ enunciado: 'É admitida a cassação de direitos políticos nos casos expressamente previstos em lei.', certa: false, explicacao: 'A CASSAÇÃO é vedada. Só há perda ou suspensão, nas hipóteses do art. 15.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'const-b1-05',
      nome: 'Garantias constitucionais individuais, coletivas, sociais e políticas',
      teoria: `
## Direito × garantia
...
`,
      questoes: [
        { id: 'const-b1-05-q1', enunciado: 'O habeas corpus pode ser impetrado por qualquer pessoa, em favor próprio ou de terceiro, independentemente de representação por advogado.', certa: true, explicacao: 'A legitimidade no HC é universal, e o remédio é gratuito. Admite as modalidades preventiva e repressiva.', baseLegal: 'CF/88, art. 5º, LXVIII e LXXVII', variacoes: [{ enunciado: 'O habeas data pode ser impetrado por qualquer pessoa em favor de terceiro cujos dados constem de banco público.', certa: false, explicacao: 'O habeas data é personalíssimo: só o próprio titular das informações (ou seus sucessores) pode impetrá-lo.' }] },
        { id: 'const-b1-05-q2', enunciado: 'O mandado de segurança coletivo pode ser impetrado por associação legalmente constituída e em funcionamento há pelo menos um ano, em defesa dos interesses de seus membros.', certa: true, explicacao: 'É o requisito do art. 5º, LXX, "b". Partidos políticos com representação no Congresso não se sujeitam ao prazo de um ano.', baseLegal: 'CF/88, art. 5º, LXX', variacoes: [{ enunciado: 'O prazo para impetração do mandado de segurança é prescricional e de cento e oitenta dias.', certa: false, explicacao: 'O prazo é DECADENCIAL e de 120 dias, contados da ciência do ato impugnado.' }] },
        { id: 'const-b1-05-q3', enunciado: 'A ação popular pode ser proposta por qualquer cidadão para anular ato lesivo ao patrimônio público, à moralidade administrativa e ao meio ambiente.', certa: true, explicacao: 'Art. 5º, LXXIII. O autor fica isento de custas e do ônus da sucumbência, salvo comprovada má-fé.', baseLegal: 'CF/88, art. 5º, LXXIII', variacoes: [{ enunciado: 'A ação popular pode ser proposta por qualquer pessoa, brasileira ou estrangeira, residente no país.', certa: false, explicacao: 'A legitimidade é do CIDADÃO — quem está no gozo dos direitos políticos, comprovado pelo título de eleitor.' }] },
        { id: 'const-b1-05-q4', enunciado: 'O mandado de injunção é cabível quando a falta de norma regulamentadora torne inviável o exercício de direitos e liberdades constitucionais.', certa: true, explicacao: 'Art. 5º, LXXI. O STF adota hoje a corrente concretista, podendo viabilizar o exercício do direito enquanto durar a omissão.', baseLegal: 'CF/88, art. 5º, LXXI; Lei nº 13.300/2016', variacoes: [{ enunciado: 'O mandado de segurança é o remédio adequado para suprir a ausência de norma regulamentadora de direito constitucional.', certa: false, explicacao: 'Nesse caso o remédio é o mandado de INJUNÇÃO. O MS protege direito líquido e certo contra ato de autoridade.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'const-b1-06',
      nome: 'Administração Pública (arts. 37 a 41 da CF/88)',
      teoria: `
...
`,
      questoes: [
        { id: 'const-b1-06-q1', enunciado: 'É vedado a estrangeiros o acesso a cargos públicos.', certa: false, explicacao: 'O art. 37, I, assegura o acesso aos brasileiros que preencham os requisitos legais E aos estrangeiros, na forma da lei. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 37, I', variacoes: [{ enunciado: 'Os cargos, empregos e funções públicas são acessíveis aos brasileiros que preencham os requisitos estabelecidos em lei, assim como aos estrangeiros, na forma da lei.', certa: true, explicacao: 'Correto — literalidade do art. 37, I.' }] },
        { id: 'const-b1-06-q2', enunciado: 'Servidor público da administração indireta investido no mandato de vereador poderá acumular as vantagens do emprego com a remuneração do cargo eletivo, se houver compatibilidade de horários.', certa: true, explicacao: 'Art. 38, III. É a única hipótese em que o servidor acumula as duas remunerações. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 38, III', variacoes: [{ enunciado: 'O servidor investido no mandato de prefeito acumula a remuneração do cargo efetivo com a do mandato, havendo compatibilidade de horários.', certa: false, explicacao: 'No caso de prefeito, o servidor é afastado do cargo, podendo optar pela remuneração. A acumulação é privativa do vereador com compatibilidade.' }] },
        { id: 'const-b1-06-q3', enunciado: 'Os vencimentos dos cargos integrantes dos Poderes Legislativo e Judiciário não poderão exceder os pagos aos cargos do Poder Executivo.', certa: true, explicacao: 'Art. 37, XII, da CF/88. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 37, XII', variacoes: [{ enunciado: 'O prazo de validade do concurso público é de até dois anos, prorrogável uma única vez por igual período.', certa: true, explicacao: 'Correto — art. 37, III, da CF/88.' }] },
        { id: 'const-b1-06-q4', enunciado: 'A estabilidade do servidor nomeado para cargo de provimento efetivo em virtude de concurso público é adquirida após três anos de efetivo exercício, condicionada à avaliação especial de desempenho.', certa: true, explicacao: 'Art. 41, caput e §4º. O servidor estável só perde o cargo por sentença transitada em julgado, PAD ou avaliação periódica de desempenho.', baseLegal: 'CF/88, art. 41', variacoes: [{ enunciado: 'A acumulação remunerada de dois cargos privativos de profissionais de saúde é vedada em qualquer hipótese.', certa: false, explicacao: 'É permitida quando houver compatibilidade de horários e as profissões forem regulamentadas (art. 37, XVI, "c").' }] },
      ],
      flashcards: [
