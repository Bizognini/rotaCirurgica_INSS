/**
 * Direito Previdenciário — Bloco 2: financiamento da seguridade social
 */
export default {
  id: 'prev-b2',
  materiaId: 'prev',
  ...
  ordem: 2,
  objetivo: 'Custeio, salário de contribuição, arrecadação, prazos, decadência e crimes.',
  topicos: [
    /* ------------------------------------------------------------------ 01 */
    {
      id: 'prev-b2-01',
      nome: 'Financiamento da Seguridade Social: receitas da União',
      teoria: `
...
`,
      questoes: [
        {
          id: 'prev-b2-01-q1', enunciado: 'A seguridade social será financiada por toda a sociedade, de forma direta e indireta, mediante recursos provenientes dos orçamentos da União, dos estados, do Distrito Federal e dos municípios, além das contribuições sociais.',
          certa: true, explicacao: 'Reprodução do art. 195, caput, da CF/88. Todos os entes federados participam do financiamento.', baseLegal: 'CF/88, art. 195, caput',
          variacoes: [{ enunciado: 'O financiamento da seguridade social é atribuição exclusiva da União, por meio das contribuições sociais.', certa: false, explicacao: 'O art. 195 envolve União, Estados, DF e Municípios, e o custeio é direto (contribuições) e indireto (orçamentos).' }],
        },
        {
          id: 'prev-b2-01-q2', enunciado: 'Incide contribuição previdenciária sobre a aposentadoria e a pensão concedidas pelo Regime Geral de Previdência Social.',
          certa: false, explicacao: 'O art. 195, II, da CF/88 é expresso ao excluir da incidência a aposentadoria e a pensão concedidas pelo RGPS. A cobrança sobre proventos existe apenas nos regimes próprios, na parcela que excede o teto do RGPS.', baseLegal: 'CF/88, art. 195, II',
          variacoes: [{ enunciado: 'A contribuição do trabalhador incide sobre o salário de contribuição, não alcançando a aposentadoria concedida pelo RGPS.', certa: true, explicacao: 'Correto, conforme a parte final do art. 195, II.' }],
        },
        {
          id: 'prev-b2-01-q3', enunciado: 'A instituição de nova fonte de custeio da seguridade social, não prevista expressamente na Constituição, pode ser feita por lei ordinária, desde que respeitada a anterioridade nonagesimal.',
          certa: false, explicacao: 'A competência residual do art. 195, §4º, remete ao art. 154, I, exigindo LEI COMPLEMENTAR, não cumulatividade e fato gerador diverso dos impostos já discriminados.', baseLegal: 'CF/88, arts. 195, §4º, e 154, I',
          variacoes: [{ enunciado: 'Nova fonte destinada a garantir a manutenção ou expansão da seguridade social somente pode ser instituída por lei complementar.', certa: true, explicacao: 'Correto — é a competência residual do art. 195, §4º, c/c art. 154, I.' }],
        },
        {
          id: 'prev-b2-01-q4', enunciado: 'Constitui receita da seguridade social percentual do valor total do resultado dos leilões de bens apreendidos pela Receita Federal do Brasil.',
          certa: true, explicacao: 'A Lei nº 8.212/91 arrola entre as receitas da seguridade 50% do resultado dos leilões de bens apreendidos pela Receita Federal.', baseLegal: 'Lei nº 8.212/91, art. 27, VI',
          variacoes: [{ enunciado: 'Multas, atualização monetária e juros moratórios cobrados de contribuintes inadimplentes constituem receita da seguridade social.', certa: true, explicacao: 'Correto, conforme o art. 27, I, da Lei nº 8.212/91.' }],
        },
        {
          id: 'prev-b2-01-q5', enunciado: 'A pessoa jurídica em débito com o sistema da seguridade social poderá contratar com o Poder Público, desde que ofereça garantia idônea do débito existente.',
          certa: false, explicacao: 'O art. 195, §3º, da CF/88 veda de forma direta a contratação com o Poder Público e o recebimento de benefícios ou incentivos fiscais ou creditícios, sem ressalva de garantia.', baseLegal: 'CF/88, art. 195, §3º',
          variacoes: [{ enunciado: 'A seguridade social possui orçamento próprio, distinto do orçamento fiscal da União.', certa: true, explicacao: 'Correto — art. 165, §5º, III, da CF/88.' }],
        },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b2-02',
      nome: 'Receitas das contribuições sociais (segurados, empresas, produtor rural, prognósticos)',
      teoria: `
...
`,
      questoes: [
        {
          id: 'prev-b2-02-q1', enunciado: 'A contribuição do segurado empregado é calculada mediante aplicação de alíquotas progressivas e incidentes de forma cumulativa sobre o salário de contribuição, por faixas.',
          certa: true, explicacao: 'Após a EC 103/2019 a alíquota do empregado é progressiva por faixas (7,5% a 14%), aplicando-se cada percentual apenas sobre a parcela correspondente — mesma lógica do imposto de renda.', baseLegal: 'EC nº 103/2019, art. 28; Lei nº 8.212/91, art. 20',
          variacoes: [{ enunciado: 'A alíquota do segurado empregado que recebe remuneração próxima ao teto incide de forma única, no percentual de 14%, sobre a totalidade do salário de contribuição.', certa: false, explicacao: 'A progressividade é por faixas: cada parcela da remuneração é tributada pela alíquota da respectiva faixa.' }],
        },
        {
          id: 'prev-b2-02-q2', enunciado: 'A alíquota de contribuição do empregador doméstico corresponde a 8% sobre o salário de contribuição do empregado, acrescida de 0,8% destinado ao financiamento do seguro contra acidentes do trabalho.',
          certa: true, explicacao: 'É a regra da LC nº 150/2015, recolhida por meio do DAE unificado do eSocial Doméstico.', baseLegal: 'LC nº 150/2015, art. 34',
          variacoes: [{ enunciado: 'O empregador doméstico recolhe contribuição patronal de 20% sobre a remuneração do empregado, tal como a empresa.', certa: false, explicacao: 'A alíquota patronal do doméstico é de 8%, mais 0,8% de seguro-acidente.' }],
        },
        {
          id: 'prev-b2-02-q3', enunciado: 'A alíquota da contribuição da empresa destinada ao financiamento dos benefícios decorrentes dos riscos ambientais do trabalho é ajustada pelo Fator Acidentário de Prevenção, que pode reduzi-la à metade ou dobrá-la.',
          certa: true, explicacao: 'O FAP multiplica a alíquota RAT (1%, 2% ou 3%) por um índice que varia de 0,5 a 2,0, conforme o desempenho da empresa em acidentalidade.', baseLegal: 'Lei nº 10.666/2003, art. 10',
          variacoes: [{ enunciado: 'As alíquotas de contribuição para o RAT são fixas em 3% para todas as empresas, independentemente do grau de risco da atividade.', certa: false, explicacao: 'São 1%, 2% ou 3%, conforme o risco seja leve, médio ou grave, e ainda ajustadas pelo FAP.' }],
        },
        {
          id: 'prev-b2-02-q4', enunciado: 'As igrejas e os templos de qualquer culto são imunes às contribuições destinadas à seguridade social.',
          certa: false, explicacao: 'A imunidade do art. 150, VI, "b", alcança apenas IMPOSTOS. Templos recolhem normalmente as contribuições previdenciárias sobre a remuneração de seus empregados.', baseLegal: 'CF/88, arts. 150, VI, "b", e 195, §7º',
          variacoes: [{ enunciado: 'São isentas de contribuição para a seguridade social as entidades beneficentes de assistência social que atendam às exigências estabelecidas em lei complementar.', certa: true, explicacao: 'Correto, conforme o art. 195, §7º, da CF/88.' }],
        },
        {
          id: 'prev-b2-02-q5', enunciado: 'A contribuição incidente sobre concursos de prognósticos tem por base de cálculo a receita bruta obtida com a venda dos bilhetes.',
          certa: false, explicacao: 'A base de cálculo é a RENDA LÍQUIDA dos concursos de prognósticos, e não a receita bruta.', baseLegal: 'Lei nº 8.212/91, art. 26',
          variacoes: [{ enunciado: 'A associação desportiva que mantém equipe de futebol profissional contribui com 5% da receita bruta de espetáculos desportivos, em substituição à contribuição sobre a folha de salários.', certa: true, explicacao: 'Correto, conforme o art. 22, §6º, da Lei nº 8.212/91.' }],
        },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b2-03',
      nome: 'Salário de contribuição: conceito, parcelas integrantes e não integrantes',
      teoria: `
## Conceito
...
`,
      questoes: [
        {
          id: 'prev-b2-03-q1', enunciado: 'O salário-maternidade é a única prestação previdenciária que integra o salário de contribuição.',
          certa: true, explicacao: 'É a exceção clássica: apesar de ser benefício, o salário-maternidade compõe o salário de contribuição, sofrendo incidência de contribuição previdenciária.', baseLegal: 'Lei nº 8.212/91, art. 28, §2º',
          variacoes: [{ enunciado: 'O auxílio-acidente e o salário-família integram o salário de contribuição do segurado empregado.', certa: false, explicacao: 'Ambos estão expressamente excluídos pelo art. 28, §9º, da Lei nº 8.212/91.' }],
        },
        {
          id: 'prev-b2-03-q2', enunciado: 'As férias indenizadas e o respectivo adicional constitucional integram o salário de contribuição.',
          certa: false, explicacao: 'Verbas indenizatórias não integram o salário de contribuição. As férias INDENIZADAS e seu terço estão expressamente excluídas — diferente das férias gozadas, que integram.', baseLegal: 'Lei nº 8.212/91, art. 28, §9º, "d"',
          variacoes: [{ enunciado: 'A licença-prêmio indenizada integra o salário de contribuição, nos termos da legislação.', certa: false, explicacao: 'É verba indenizatória, expressamente excluída pelo art. 28, §9º.' }],
        },
        {
          id: 'prev-b2-03-q3', enunciado: 'O salário de contribuição do segurado facultativo corresponde ao valor por ele declarado, observados os limites mínimo e máximo.',
          certa: true, explicacao: 'Diferentemente do empregado, cuja base é a remuneração auferida, o facultativo declara o valor sobre o qual deseja contribuir, entre o piso e o teto.', baseLegal: 'Lei nº 8.212/91, art. 28, IV',
          variacoes: [{ enunciado: 'O segurado especial possui salário de contribuição correspondente ao valor da produção rural comercializada no mês.', certa: false, explicacao: 'O segurado especial não possui salário de contribuição: sua contribuição incide sobre a receita bruta da comercialização da produção.' }],
        },
        {
          id: 'prev-b2-03-q4', enunciado: 'As diárias para viagem integram o salário de contribuição quando excederem cinquenta por cento da remuneração mensal do empregado.',
          certa: true, explicacao: 'Diárias até 50% da remuneração mensal não integram; a partir daí, integram em sua totalidade.', baseLegal: 'Lei nº 8.212/91, art. 28, §8º, "a"',
          variacoes: [{ enunciado: 'A participação nos lucros ou resultados paga na forma de lei específica integra o salário de contribuição.', certa: false, explicacao: 'A PLR, quando paga conforme a lei específica, é expressamente desvinculada da remuneração e não integra o salário de contribuição.' }],
        },
        {
          id: 'prev-b2-03-q5', enunciado: 'O décimo terceiro salário integra o salário de contribuição e é somado à remuneração do mês de dezembro para efeito de aplicação do limite máximo.',
          certa: false, explicacao: 'O 13º integra o salário de contribuição, mas em base de cálculo APARTADA: o teto é aplicado separadamente sobre o 13º e sobre a remuneração mensal.', baseLegal: 'Lei nº 8.212/91, art. 28, §7º',
          variacoes: [{ enunciado: 'O valor do vale-transporte, ainda que pago em dinheiro, não integra o salário de contribuição.', certa: true, explicacao: 'Correto, conforme entendimento consolidado do STF (RE 478.410).' }],
        },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b2-04',
      nome: 'Limites mínimo e máximo do salário de contribuição',
      teoria: `
## Limite mínimo
...
`,
      questoes: [
        {
          id: 'prev-b2-04-q1', enunciado: 'Os valores do salário de contribuição são reajustados na mesma época e com os mesmos índices dos benefícios de prestação continuada da previdência social.',
          certa: true, explicacao: 'Literalidade do art. 20, §1º, da Lei nº 8.212/91 — item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.212/91, art. 20, §1º',
          variacoes: [{ enunciado: 'O limite máximo do salário de contribuição é reajustado anualmente pelo índice de variação do salário mínimo.', certa: false, explicacao: 'O reajuste segue os índices dos benefícios de prestação continuada, não a variação do salário mínimo.' }],
        },
        {
          id: 'prev-b2-04-q2', enunciado: 'Para o segurado empregado, o limite mínimo do salário de contribuição corresponde ao piso salarial legal ou normativo da categoria ou, na falta deste, ao salário mínimo.',
          certa: true, explicacao: 'É a regra do art. 28, §3º, da Lei nº 8.212/91, observadas as proporções para jornadas reduzidas.', baseLegal: 'Lei nº 8.212/91, art. 28, §3º',
          variacoes: [{ enunciado: 'O limite mínimo do salário de contribuição do contribuinte individual corresponde ao piso normativo da categoria profissional a que pertence.', certa: false, explicacao: 'Para contribuinte individual e facultativo o piso é o salário mínimo mensal; piso normativo vale para empregado, doméstico e avulso.' }],
        },
        {
          id: 'prev-b2-04-q3', enunciado: 'O segurado que exerce atividades concomitantes tem os salários de contribuição de cada uma somados, observado o limite máximo único.',
          certa: true, explicacao: 'Há um único teto por segurado, e não um teto por vínculo. Cabe ao segurado informar às empresas os valores já recebidos.', baseLegal: 'Lei nº 8.212/91, art. 28, §5º',
          variacoes: [{ enunciado: 'O segurado com dois vínculos empregatícios submete-se ao limite máximo do salário de contribuição de forma autônoma em cada um deles.', certa: false, explicacao: 'O teto é único e considera a soma das remunerações de todas as atividades.' }],
        },
        {
          id: 'prev-b2-04-q4', enunciado: 'É possível a concessão de benefício previdenciário do RGPS em valor superior ao limite máximo do salário de contribuição, desde que o segurado tenha contribuído por período superior a trinta e cinco anos.',
          certa: false, explicacao: 'Nenhum benefício do RGPS pode superar o teto do salário de contribuição, independentemente do tempo contribuído. Renda maior depende de previdência complementar.', baseLegal: 'Lei nº 8.213/91, art. 29, §2º; CF/88, art. 201, §2º',
          variacoes: [{ enunciado: 'O salário de benefício não pode ser inferior a um salário mínimo nem superior ao limite máximo do salário de contribuição na data de início do benefício.', certa: true, explicacao: 'Correto — art. 29, §2º, da Lei nº 8.213/91.' }],
        },
      ],
      flashcards: [
...
`,
      questoes: [
        {
          id: 'prev-b2-05-q1', enunciado: 'O segurado que, no somatório de remunerações do mês, receber valor inferior ao salário mínimo poderá agrupar contribuições inferiores ao limite mínimo de diferentes competências, ainda que de anos civis distintos.',
          certa: false, explicacao: 'O agrupamento e o aproveitamento de excedentes só podem ocorrer dentro do MESMO ANO CIVIL.', baseLegal: 'EC nº 103/2019, art. 29, §1º, III',
          variacoes: [{ enunciado: 'É permitido utilizar o valor excedente ao limite mínimo de uma competência para completar a contribuição de outra competência do mesmo ano civil.', certa: true, explicacao: 'Correto — é a segunda alternativa do art. 29, §1º, da EC 103/2019.' }],
        },
        {
          id: 'prev-b2-05-q2', enunciado: 'A competência cuja contribuição seja inferior ao limite mínimo e que não seja regularizada não será considerada para fins de carência, tempo de contribuição e manutenção da qualidade de segurado.',
          certa: true, explicacao: 'É a consequência expressa do art. 29, §2º, da EC 103/2019: a competência simplesmente não conta.', baseLegal: 'EC nº 103/2019, art. 29, §2º',
          variacoes: [{ enunciado: 'A competência com contribuição inferior ao mínimo, ainda que não regularizada, conta normalmente para efeito de carência.', certa: false, explicacao: 'Sem regularização a competência não é computada para nenhum fim previdenciário.' }],
        },
        {
          id: 'prev-b2-05-q3', enunciado: 'O segurado que optou pelo recolhimento com alíquota de 11% sobre o salário mínimo e pretenda contar esse tempo para efeito de contagem recíproca deverá complementar a contribuição, acrescida de juros moratórios.',
          certa: true, explicacao: 'O plano simplificado exclui a aposentadoria por tempo de contribuição e a contagem recíproca, salvo complementação da diferença de alíquota com juros.', baseLegal: 'Lei nº 8.212/91, art. 21, §§2º e 3º',
          variacoes: [{ enunciado: 'O recolhimento pelo plano simplificado assegura ao segurado todos os benefícios do RGPS, inclusive a aposentadoria por tempo de contribuição.', certa: false, explicacao: 'O plano simplificado exclui expressamente a aposentadoria por tempo de contribuição e a contagem recíproca.' }],
        },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b2-06',
      nome: 'Arrecadação e recolhimento: competência INSS x Receita Federal',
      teoria: `
...
`,
      questoes: [
        {
          id: 'prev-b2-06-q1', enunciado: 'Compete ao INSS planejar, executar e avaliar as atividades relativas à tributação, à fiscalização e à arrecadação das contribuições previdenciárias.',
          certa: false, explicacao: 'Desde a Lei nº 11.457/2007, essas atribuições são da Receita Federal do Brasil. Ao INSS cabe conceder e manter benefícios e prestar serviços previdenciários. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 11.457/2007, arts. 2º e 3º',
          variacoes: [{ enunciado: 'A cobrança judicial da dívida ativa decorrente das contribuições previdenciárias compete à Procuradoria-Geral da Fazenda Nacional.', certa: true, explicacao: 'Correto, conforme o art. 16 da Lei nº 11.457/2007.' }],
        },
        {
          id: 'prev-b2-06-q2', enunciado: 'O trabalhador avulso deve recolher pessoalmente sua contribuição previdenciária, tal como o contribuinte individual que trabalha por conta própria.',
          certa: false, explicacao: 'A contribuição do avulso é descontada e recolhida pela empresa, pelo OGMO ou pelo sindicato. Item cobrado na prova de 2022 (item 71).', baseLegal: 'Lei nº 8.212/91, art. 30, I e VI',
          variacoes: [{ enunciado: 'Cabe à empresa arrecadar a contribuição do segurado empregado a seu serviço, descontando-a da respectiva remuneração.', certa: true, explicacao: 'Correto — art. 30, I, "a", da Lei nº 8.212/91.' }],
        },
        {
          id: 'prev-b2-06-q3', enunciado: 'A empresa que não efetuou o desconto da contribuição do segurado empregado pode alegar essa omissão para eximir-se do recolhimento.',
          certa: false, explicacao: 'Presume-se feito o desconto, não sendo lícito à empresa alegar omissão: ela responde diretamente pela importância que deixou de descontar.', baseLegal: 'Lei nº 8.212/91, art. 33, §5º',
          variacoes: [{ enunciado: 'A empresa deve manter à disposição da fiscalização, pelo prazo de dez anos, os documentos relacionados às contribuições previdenciárias.', certa: true, explicacao: 'Correto, conforme o art. 32, §11, da Lei nº 8.212/91.' }],
        },
        {
          id: 'prev-b2-06-q4', enunciado: 'A empresa deve recolher as contribuições previdenciárias até o dia vinte do mês seguinte ao da competência, antecipando-se o prazo se não houver expediente bancário nesse dia.',
          certa: true, explicacao: 'É a regra do art. 30, I, "b", da Lei nº 8.212/91. Para empresa e doméstico o prazo se antecipa; para contribuinte individual e facultativo, prorroga-se.', baseLegal: 'Lei nº 8.212/91, art. 30, I, "b"',
          variacoes: [{ enunciado: 'O empregador doméstico deve recolher as contribuições até o dia quinze do mês seguinte ao da competência.', certa: false, explicacao: 'O prazo do doméstico é até o dia 7 do mês seguinte, por meio do DAE. O dia 15 é do contribuinte individual e do facultativo.' }],
        },
        {
          id: 'prev-b2-06-q5', enunciado: 'A contribuição incidente sobre a receita bruta de espetáculo desportivo deve ser recolhida até dois dias úteis após a realização do evento.',
          certa: true, explicacao: 'Prazo especialíssimo do art. 22, §7º, da Lei nº 8.212/91, cobrado com frequência justamente por destoar dos demais.', baseLegal: 'Lei nº 8.212/91, art. 22, §7º',
          variacoes: [{ enunciado: 'A contribuição do segurado especial sobre a comercialização da produção deve ser recolhida até o dia vinte do mês seguinte ao da operação de venda.', certa: true, explicacao: 'Correto, conforme o art. 30, X, da Lei nº 8.212/91.' }],
        },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b2-07',
      nome: 'Obrigações da empresa e prazos de recolhimento',
      teoria: `
...
`,
      questoes: [
        {
          id: 'prev-b2-07-q1', enunciado: 'A empresa contratante de serviços executados mediante cessão de mão de obra deve reter onze por cento do valor bruto da nota fiscal e recolher a importância em nome da empresa cedente.',
          certa: true, explicacao: 'É a retenção do art. 31 da Lei nº 8.212/91, cuja responsabilidade é da CONTRATANTE, e o recolhimento se dá em nome da contratada.', baseLegal: 'Lei nº 8.212/91, art. 31',
          variacoes: [{ enunciado: 'A responsabilidade pela retenção de onze por cento na cessão de mão de obra é da empresa prestadora do serviço.', certa: false, explicacao: 'A obrigação de reter é da empresa CONTRATANTE (tomadora), não da prestadora.' }],
        },
        {
          id: 'prev-b2-07-q2', enunciado: 'A empresa deve comunicar o acidente do trabalho à previdência social até o primeiro dia útil seguinte ao da ocorrência e, em caso de morte, de imediato.',
          certa: true, explicacao: 'É a regra de emissão da CAT prevista no art. 22 da Lei nº 8.213/91.', baseLegal: 'Lei nº 8.213/91, art. 22',
          variacoes: [{ enunciado: 'A comunicação de acidente do trabalho deve ser feita pela empresa no prazo de trinta dias contados da ocorrência.', certa: false, explicacao: 'O prazo é até o primeiro dia útil seguinte; em caso de morte, imediatamente.' }],
        },
        {
          id: 'prev-b2-07-q3', enunciado: 'O proprietário e o incorporador de obra de construção civil respondem solidariamente com o construtor pelas contribuições previdenciárias incidentes sobre a obra.',
          certa: true, explicacao: 'A solidariedade do art. 30, VI, da Lei nº 8.212/91 não comporta benefício de ordem: o fisco pode exigir de qualquer um dos coobrigados.', baseLegal: 'Lei nº 8.212/91, art. 30, VI',
          variacoes: [{ enunciado: 'Na responsabilidade solidária por contribuições previdenciárias, o devedor solidário pode invocar benefício de ordem para que a cobrança recaia primeiro sobre o devedor principal.', certa: false, explicacao: 'A solidariedade em matéria tributária não comporta benefício de ordem (CTN, art. 124, parágrafo único).' }],
        },
        {
          id: 'prev-b2-07-q4', enunciado: 'A empresa está obrigada a lançar mensalmente em títulos próprios de sua contabilidade, de forma discriminada, os fatos geradores das contribuições e os valores recolhidos.',
          certa: true, explicacao: 'Obrigação acessória do art. 32, II, da Lei nº 8.212/91, essencial para a conferência pela fiscalização.', baseLegal: 'Lei nº 8.212/91, art. 32, II',
          variacoes: [{ enunciado: 'A empresa deve fornecer ao segurado comprovante do pagamento de remuneração, com identificação da empresa e discriminação do valor descontado a título de contribuição previdenciária.', certa: true, explicacao: 'Correto — art. 32, IV, e art. 33, §1º, da Lei nº 8.212/91.' }],
        },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b2-08',
      nome: 'Recolhimento fora do prazo: juros, multa e atualização monetária',
      teoria: `
...
`,
      questoes: [
        {
          id: 'prev-b2-08-q1', enunciado: 'A multa de mora incidente sobre contribuições previdenciárias recolhidas espontaneamente em atraso corresponde a 0,33% por dia de atraso, limitada a 20%.',
          certa: true, explicacao: 'É a multa moratória padrão dos tributos federais, aplicável quando o pagamento ocorre antes de procedimento fiscal.', baseLegal: 'Lei nº 9.430/96, art. 61',
          variacoes: [{ enunciado: 'A multa de mora por recolhimento em atraso de contribuição previdenciária é de 75% do valor devido.', certa: false, explicacao: '75% é a multa de OFÍCIO, aplicada em lançamento pela fiscalização. A de mora é 0,33% ao dia, limitada a 20%.' }],
        },
        {
          id: 'prev-b2-08-q2', enunciado: 'Os juros de mora incidentes sobre contribuições previdenciárias em atraso são calculados com base na taxa SELIC acumulada mensalmente, acrescida de um por cento no mês do pagamento.',
          certa: true, explicacao: 'É a sistemática dos tributos federais desde a Lei nº 9.430/96.', baseLegal: 'Lei nº 9.430/96, art. 61, §3º',
          variacoes: [{ enunciado: 'A multa de ofício é majorada para 150% nas hipóteses de sonegação, fraude ou conluio.', certa: true, explicacao: 'Correto — art. 44, §1º, da Lei nº 9.430/96 c/c arts. 71 a 73 da Lei nº 4.502/64.' }],
        },
        {
          id: 'prev-b2-08-q3', enunciado: 'O parcelamento do débito previdenciário suspende a exigibilidade do crédito tributário, permitindo a expedição de certidão positiva com efeitos de negativa.',
          certa: true, explicacao: 'O parcelamento é causa de suspensão da exigibilidade prevista no art. 151, VI, do CTN, o que autoriza a CPEN do art. 206.', baseLegal: 'CTN, arts. 151, VI, e 206',
          variacoes: [{ enunciado: 'O parcelamento do débito previdenciário extingue o crédito tributário e afasta a incidência de juros e multa já constituídos.', certa: false, explicacao: 'O parcelamento SUSPENDE a exigibilidade; não extingue o crédito nem afasta encargos já constituídos.' }],
        },
        {
          id: 'prev-b2-08-q4', enunciado: 'O segurado empregado cuja empresa deixou de recolher as contribuições em dia terá o período correspondente desconsiderado para efeito de carência.',
          certa: false, explicacao: 'A responsabilidade pelo recolhimento é da empresa, e sua inadimplência não prejudica o empregado. O período conta normalmente.', baseLegal: 'Lei nº 8.213/91, art. 34, I',
          variacoes: [{ enunciado: 'O segurado facultativo pode recolher contribuições relativas a período anterior à sua inscrição, desde que comprove que não exercia atividade remunerada.', certa: false, explicacao: 'O facultativo não pode: antes do primeiro recolhimento não havia filiação. Essa possibilidade existe apenas para o contribuinte individual, que já era filiado pelo exercício da atividade.' }],
        },
      ],
      flashcards: [
...
`,
      questoes: [
        {
          id: 'prev-b2-09-q1', enunciado: 'O direito do segurado de requerer benefício previdenciário prescreve em cinco anos, contados da data em que preenchidos os requisitos.',
          certa: false, explicacao: 'O direito ao benefício é IMPRESCRITÍVEL. Prescrevem em 5 anos apenas as prestações vencidas e não pagas. Item cobrado duas vezes na prova de 2022.', baseLegal: 'Lei nº 8.213/91, art. 103, parágrafo único',
          variacoes: [{ enunciado: 'Prescreve em cinco anos o direito às prestações não pagas nem reclamadas na época própria, ressalvado o direito dos menores, incapazes e ausentes.', certa: true, explicacao: 'Correto — art. 103, parágrafo único, da Lei nº 8.213/91.' }],
        },
        {
          id: 'prev-b2-09-q2', enunciado: 'O prazo de decadência para revisão do ato de concessão de benefício é de dez anos, contados do dia primeiro do mês seguinte ao do recebimento da primeira prestação.',
          certa: true, explicacao: 'Literalidade do art. 103 da Lei nº 8.213/91. Benefício concedido em 05/12/2015 tem termo inicial em 01/01/2016 e prazo final em 01/01/2026.', baseLegal: 'Lei nº 8.213/91, art. 103',
          variacoes: [{ enunciado: 'O prazo decadencial para revisão do ato de concessão do benefício conta-se da data do requerimento administrativo.', certa: false, explicacao: 'Conta-se do dia primeiro do mês seguinte ao do recebimento da primeira prestação.' }],
        },
        {
          id: 'prev-b2-09-q3', enunciado: 'Comprovada a má-fé do beneficiário, o direito da previdência social de anular o ato de concessão do benefício não se submete ao prazo decadencial de dez anos.',
          certa: true, explicacao: 'O art. 103-A ressalva expressamente a má-fé: nesse caso, a revisão pode ocorrer a qualquer tempo. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.213/91, art. 103-A',
          variacoes: [{ enunciado: 'O benefício obtido mediante fraude convalida-se após dez anos, em razão da decadência do direito da Administração de anulá-lo.', certa: false, explicacao: 'Havendo má-fé, não há decadência: o ato pode ser anulado a qualquer tempo.' }],
        },
        {
          id: 'prev-b2-09-q4', enunciado: 'O prazo de decadência para a constituição dos créditos da seguridade social é de dez anos, nos termos da Lei nº 8.212/1991.',
          certa: false, explicacao: 'A Súmula Vinculante 8 do STF declarou inconstitucionais os arts. 45 e 46 da Lei nº 8.212/91. Prevalece o prazo de 5 anos do CTN, por exigir lei complementar.', baseLegal: 'STF, Súmula Vinculante 8; CTN, arts. 173 e 174',
          variacoes: [{ enunciado: 'São inconstitucionais os dispositivos legais que fixaram em dez anos os prazos de decadência e prescrição de crédito tributário previdenciário.', certa: true, explicacao: 'Correto — teor da Súmula Vinculante 8 do STF.' }],
        },
      ],
      flashcards: [
...
`,
      questoes: [
        {
          id: 'prev-b2-10-q1', enunciado: 'A empresa que desconta a contribuição previdenciária devida pelos trabalhadores e não a repassa à previdência social comete o crime de apropriação indébita previdenciária.',
          certa: true, explicacao: 'É exatamente a conduta do art. 168-A do Código Penal: o valor descontado já não pertencia à empresa. Item cobrado na prova de 2022.', baseLegal: 'Código Penal, art. 168-A',
          variacoes: [{ enunciado: 'Omitir de folha de pagamento segurado empregado, com o fim de suprimir contribuição previdenciária, caracteriza sonegação de contribuição previdenciária.', certa: true, explicacao: 'Correto — art. 337-A, I, do Código Penal.' }],
        },
        {
          id: 'prev-b2-10-q2', enunciado: 'Extingue-se a punibilidade dos crimes de apropriação indébita e sonegação previdenciária quando o agente promove o pagamento das contribuições devidas antes da prolação da sentença de primeiro grau.',
          certa: false, explicacao: 'O marco legal é o INÍCIO DA AÇÃO FISCAL, e não a sentença. Pagamento posterior pode, no máximo, gerar perdão judicial ou aplicação isolada de multa. Item cobrado na prova de 2022.', baseLegal: 'Código Penal, arts. 168-A, §2º, e 337-A, §1º',
          variacoes: [{ enunciado: 'A punibilidade é extinta se o agente, espontaneamente, declara, confessa e efetua o pagamento das contribuições antes do início da ação fiscal.', certa: true, explicacao: 'Correto — art. 168-A, §2º, do Código Penal.' }],
        },
        {
          id: 'prev-b2-10-q3', enunciado: 'O juiz pode deixar de aplicar a pena ou aplicar somente a multa ao agente primário e de bons antecedentes que efetua o pagamento após o início da ação fiscal, mas antes do oferecimento da denúncia.',
          certa: true, explicacao: 'É a hipótese de perdão judicial facultativo do art. 168-A, §3º, I, do Código Penal.', baseLegal: 'Código Penal, art. 168-A, §3º, I',
          variacoes: [{ enunciado: 'A pena cominada aos crimes de apropriação indébita previdenciária e de sonegação de contribuição previdenciária é de detenção de um a três anos.', certa: false, explicacao: 'A pena é de RECLUSÃO de 2 a 5 anos, e multa, em ambos os tipos.' }],
        },
        {
          id: 'prev-b2-10-q4', enunciado: 'Segundo entendimento do STF, o estelionato previdenciário praticado pelo próprio beneficiário que recebe prestações de forma continuada é crime instantâneo de efeitos permanentes.',
          certa: false, explicacao: 'Para o beneficiário que recebe continuadamente, o STF considera crime PERMANENTE, de modo que a prescrição só começa a correr do último recebimento. Instantâneo de efeitos permanentes é o do terceiro falsário.', baseLegal: 'Código Penal, art. 171, §3º; STF, HC 99.112',
          variacoes: [{ enunciado: 'Inserir declaração falsa em documento contábil destinado a fazer prova perante a previdência social configura crime de falsificação de documento público.', certa: true, explicacao: 'Correto — art. 297, §§3º e 4º, do Código Penal.' }],
        },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b2-11',
      nome: 'Recurso das decisões administrativas (CRPS)',
      teoria: `
...
`,
      questoes: [
        {
          id: 'prev-b2-11-q1', enunciado: 'Compete ao Conselho de Recursos da Previdência Social julgar os recursos das decisões do INSS nos processos de interesse dos beneficiários do RGPS.',
          certa: true, explicacao: 'É a competência central do CRPS: o contencioso administrativo previdenciário relativo a benefícios do RGPS.', baseLegal: 'Decreto nº 3.048/99, art. 303',
          variacoes: [{ enunciado: 'Compete ao Conselho de Recursos da Previdência Social julgar recursos de ofício contra decisões que anulem lançamento de crédito previdenciário.', certa: false, explicacao: 'Contencioso de crédito tributário é do CARF. Ao CRPS cabem os litígios sobre benefícios do RGPS e a supervisão dos RPPS.' }],
        },
        {
          id: 'prev-b2-11-q2', enunciado: 'A propositura, pelo recorrente, de ação judicial com objeto idêntico ao do recurso administrativo importa renúncia ao direito de recorrer e desistência do recurso interposto.',
          certa: true, explicacao: 'Aplica-se o art. 63, §2º, da Lei nº 9.784/99: a escolha da via judicial encerra a discussão administrativa. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 9.784/99, art. 63, §2º',
          variacoes: [{ enunciado: 'O ajuizamento de ação judicial com o mesmo objeto não interfere no andamento do recurso administrativo, que deve ser julgado normalmente.', certa: false, explicacao: 'A propositura da ação implica desistência automática do recurso administrativo.' }],
        },
        {
          id: 'prev-b2-11-q3', enunciado: 'As Juntas de Recursos constituem a primeira instância recursal do Conselho de Recursos da Previdência Social, e suas decisões podem ser impugnadas por recurso especial dirigido às Câmaras de Julgamento.',
          certa: true, explicacao: 'É a estrutura em dois graus do CRPS, com o Conselho Pleno atuando na uniformização de jurisprudência.', baseLegal: 'Decreto nº 3.048/99, art. 303 e seguintes',
          variacoes: [{ enunciado: 'O prazo para interposição de recurso ordinário contra decisão do INSS é de quinze dias, contados da ciência da decisão.', certa: false, explicacao: 'O prazo é de 30 dias, tanto para recorrer quanto para apresentar contrarrazões.' }],
        },
        {
          id: 'prev-b2-11-q4', enunciado: 'Segundo o STF, o ajuizamento de ação previdenciária exige o prévio requerimento administrativo, salvo nas hipóteses excepcionadas pela própria Corte.',
          certa: true, explicacao: 'É a tese do RE 631.240 (Tema 350): exige-se o requerimento administrativo prévio para caracterizar o interesse de agir — sem que isso signifique esgotar as instâncias recursais.', baseLegal: 'STF, RE 631.240, Tema 350',
          variacoes: [{ enunciado: 'É admitida a reformatio in pejus no processo administrativo previdenciário, desde que o recorrente seja previamente cientificado para se manifestar.', certa: true, explicacao: 'Correto — art. 64, parágrafo único, da Lei nº 9.784/99.' }],
        },
      ],
      flashcards: [
