/**
 * Direito Administrativo — bloco único
 */
export default {
  id: 'adm-b1',
  materiaId: 'adm',
  nome: 'Bloco único — Direito Administrativo',
  ordem: 1,
  objetivo: 'Organização, agentes, poderes, atos, serviços, controle, improbidade e processo.',
  topicos: [
    {
      id: 'adm-b1-01',
      nome: 'Estado, governo e administração pública: conceitos, poderes e organização',
      teoria: `
...
`,
      questoes: [
        { id: 'adm-b1-01-q1', enunciado: 'O ato administrativo praticado por agente público no exercício da sua função expressa o sentido orgânico da administração pública.', certa: false, explicacao: 'A prática de atos corresponde ao sentido OBJETIVO (material/funcional). O sentido orgânico designa o conjunto de órgãos, entidades e agentes. Item cobrado na prova de 2022.', baseLegal: 'Doutrina; Decreto-Lei nº 200/1967', variacoes: [{ enunciado: 'O sentido subjetivo da administração pública refere-se aos órgãos, às entidades e aos agentes que exercem a função administrativa.', certa: true, explicacao: 'Correto — é o sentido subjetivo, formal ou orgânico.' }] },
        { id: 'adm-b1-01-q2', enunciado: 'A regulamentação e a fiscalização de atividade econômica de natureza privada pela administração pública caracterizam a intervenção.', certa: true, explicacao: 'O art. 174 da CF define o Estado como agente normativo e regulador, exercendo as funções de fiscalização, incentivo e planejamento. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 174', variacoes: [{ enunciado: 'O incentivo à iniciativa privada de utilidade pública mediante subvenções e benefícios fiscais caracteriza a atividade de fomento.', certa: true, explicacao: 'Correto — é uma das quatro atividades administrativas no sentido objetivo.' }] },
        { id: 'adm-b1-01-q3', enunciado: 'A transmissão de competência de uma pessoa jurídica de direito público para outra configura a descontração.', certa: false, explicacao: '"Descontração" não é instituto jurídico. A transferência entre pessoas jurídicas distintas é DESCENTRALIZAÇÃO; dentro da mesma pessoa, desconcentração. Item cobrado na prova de 2022.', baseLegal: 'Decreto-Lei nº 200/1967, arts. 6º e 10', variacoes: [{ enunciado: 'A desconcentração pressupõe relação de hierarquia, ao passo que a descentralização se submete a controle finalístico.', certa: true, explicacao: 'Correto — é a distinção central entre os dois institutos.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-02',
      nome: 'Direito administrativo: conceito, fontes e princípios',
      teoria: `
## Conceito
...
`,
      questoes: [
        { id: 'adm-b1-02-q1', enunciado: 'A Administração pode anular seus próprios atos quando eivados de vícios que os tornem ilegais, e revogá-los por motivo de conveniência e oportunidade, respeitados os direitos adquiridos.', certa: true, explicacao: 'É a Súmula 473 do STF, expressão do princípio da autotutela.', baseLegal: 'STF, Súmula 473; Lei nº 9.784/99, art. 53', variacoes: [{ enunciado: 'A revogação de ato administrativo produz efeitos retroativos, alcançando situações já consolidadas.', certa: false, explicacao: 'A revogação tem efeitos ex nunc (para o futuro). Efeitos retroativos (ex tunc) são da anulação.' }] },
        { id: 'adm-b1-02-q2', enunciado: 'O princípio da legalidade impõe ao administrador público atuar somente conforme autorização legal, diferentemente do particular, a quem é permitido fazer tudo que a lei não proíbe.', certa: true, explicacao: 'É a distinção entre legalidade estrita (Administração) e autonomia da vontade (particular).', baseLegal: 'CF/88, arts. 5º, II, e 37, caput', variacoes: [{ enunciado: 'A publicidade dos atos administrativos é absoluta, não comportando exceções.', certa: false, explicacao: 'Comporta exceções: informações cuja divulgação comprometa a intimidade ou a segurança da sociedade e do Estado (art. 5º, XXXIII e LX).' }] },
        { id: 'adm-b1-02-q3', enunciado: 'A supremacia do interesse público e a indisponibilidade do interesse público formam a base do regime jurídico-administrativo.', certa: true, explicacao: 'Da supremacia decorrem as prerrogativas; da indisponibilidade, as sujeições.', variacoes: [{ enunciado: 'O direito administrativo brasileiro é codificado, o que reduz a importância da doutrina como fonte.', certa: false, explicacao: 'Não é codificado — daí a relevância da doutrina e da jurisprudência como fontes.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-03',
      nome: 'Organização administrativa da União (direta e indireta)',
      teoria: `
...
`,
      questoes: [
        { id: 'adm-b1-03-q1', enunciado: 'As autarquias são criadas por lei específica, enquanto a criação de empresas públicas e sociedades de economia mista depende de autorização legislativa.', certa: true, explicacao: 'É a regra do art. 37, XIX, da CF/88 — distinção que a banca cobra com frequência.', baseLegal: 'CF/88, art. 37, XIX', variacoes: [{ enunciado: 'A criação de autarquia depende de autorização legislativa, seguida de registro dos atos constitutivos.', certa: false, explicacao: 'Autarquia é CRIADA diretamente por lei; a autorização legislativa vale para as entidades de direito privado.' }] },
        { id: 'adm-b1-03-q2', enunciado: 'A empresa pública possui capital exclusivamente público e pode adotar qualquer forma societária, ao passo que a sociedade de economia mista admite capital privado e deve constituir-se como sociedade anônima.', certa: true, explicacao: 'É a distinção clássica entre as duas entidades, com reflexo também no foro competente das federais.', baseLegal: 'Decreto-Lei nº 200/1967, art. 5º; Lei nº 13.303/2016', variacoes: [{ enunciado: 'As causas em que sociedade de economia mista federal for parte são processadas e julgadas na Justiça Federal.', certa: false, explicacao: 'Sociedade de economia mista federal litiga na Justiça ESTADUAL. Empresa pública federal é que vai para a Justiça Federal (art. 109, I, da CF).' }] },
        { id: 'adm-b1-03-q3', enunciado: 'O controle exercido pela administração direta sobre as entidades da administração indireta é finalístico, não havendo relação de hierarquia entre elas.', certa: true, explicacao: 'A descentralização não gera hierarquia: há supervisão ministerial, nos limites definidos em lei.', baseLegal: 'Decreto-Lei nº 200/1967, arts. 19 e 26', variacoes: [{ enunciado: 'As agências reguladoras são autarquias em regime especial, caracterizadas pela maior autonomia e por dirigentes com mandato fixo.', certa: true, explicacao: 'Correto — é justamente o que caracteriza o regime especial.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-04',
      nome: 'Agentes públicos: espécies, classificação, poderes e deveres',
      teoria: `
## Conceito amplo
...
`,
      questoes: [
        { id: 'adm-b1-04-q1', enunciado: 'Os jurados, embora colaborem temporariamente com a administração pública, não podem ser considerados agentes públicos.', certa: false, explicacao: 'Jurados são agentes públicos, na categoria de particulares em colaboração (agentes honoríficos). O conceito alcança quem exerce função pública ainda que transitoriamente e sem remuneração. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.429/1992, art. 2º', variacoes: [{ enunciado: 'Considera-se agente público todo aquele que exerce função pública, ainda que transitoriamente e sem remuneração.', certa: true, explicacao: 'Correto — é o conceito amplo adotado pela legislação e pela doutrina.' }] },
        { id: 'adm-b1-04-q2', enunciado: 'As funções de confiança devem ser exercidas exclusivamente por servidores ocupantes de cargo efetivo.', certa: true, explicacao: 'Art. 37, V, da CF/88. Já os cargos em comissão podem ser ocupados por pessoas sem vínculo, observados os percentuais mínimos reservados a servidores de carreira.', baseLegal: 'CF/88, art. 37, V', variacoes: [{ enunciado: 'Os cargos em comissão e as funções de confiança podem ser destinados a quaisquer atribuições administrativas.', certa: false, explicacao: 'Destinam-se apenas às atribuições de direção, chefia e assessoramento (art. 37, V).' }] },
        { id: 'adm-b1-04-q3', enunciado: 'As instâncias civil, penal e administrativa são independentes, ressalvada a repercussão da absolvição penal que negue a existência do fato ou a autoria.', certa: true, explicacao: 'É a regra da independência relativa das instâncias, também presente no art. 126 da Lei nº 8.112/90.', baseLegal: 'Lei nº 8.112/1990, arts. 121 a 126', variacoes: [{ enunciado: 'A Súmula Vinculante 13 do STF veda o nepotismo em relação a parentes até o quarto grau da autoridade nomeante.', certa: false, explicacao: 'O limite é até o TERCEIRO grau, em linha reta, colateral ou por afinidade.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-05',
      nome: 'Lei nº 8.112/1990: provimento, vacância, remoção, direitos e regime disciplinar',
      teoria: `
## Alcance
...
`,
      questoes: [
        { id: 'adm-b1-05-q1', enunciado: 'A condição de acionista de sociedade privada impede a posse em cargo público.', certa: false, explicacao: 'O art. 117, X, da Lei nº 8.112/90 veda participar da GERÊNCIA ou ADMINISTRAÇÃO de sociedade privada. Ser acionista, cotista ou comanditário é permitido. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.112/1990, art. 117, X', variacoes: [{ enunciado: 'É vedado ao servidor participar da gerência ou administração de sociedade privada, ressalvada a condição de acionista, cotista ou comanditário.', certa: true, explicacao: 'Correto — redação do art. 117, X, da Lei nº 8.112/90.' }] },
        { id: 'adm-b1-05-q2', enunciado: 'O prazo para a posse é de trinta dias contados da publicação do ato de provimento, e o de entrada em exercício, de quinze dias contados da posse.', certa: true, explicacao: 'São os prazos dos arts. 13 e 15 da Lei nº 8.112/90. A posse é o momento da investidura; o exercício, o início efetivo das atribuições.', baseLegal: 'Lei nº 8.112/1990, arts. 13 e 15', variacoes: [{ enunciado: 'A reintegração consiste no retorno à atividade de servidor aposentado por invalidez quando insubsistentes os motivos da aposentadoria.', certa: false, explicacao: 'Isso é REVERSÃO. Reintegração é o retorno do servidor demitido ilegalmente, com ressarcimento de vantagens.' }] },
        { id: 'adm-b1-05-q3', enunciado: 'A ação disciplinar para aplicação da penalidade de demissão prescreve em cinco anos, contados da data em que o fato se tornou conhecido.', certa: true, explicacao: 'Art. 142, I, da Lei nº 8.112/90. Suspensão prescreve em 2 anos e advertência em 180 dias.', baseLegal: 'Lei nº 8.112/1990, art. 142', variacoes: [{ enunciado: 'A exoneração constitui penalidade disciplinar prevista na Lei nº 8.112/1990.', certa: false, explicacao: 'Exoneração NÃO é penalidade. A penalidade equivalente é a DEMISSÃO.' }] },
        { id: 'adm-b1-05-q4', enunciado: 'A readaptação consiste na investidura do servidor em cargo de atribuições e responsabilidades compatíveis com a limitação sofrida em sua capacidade física ou mental, verificada em inspeção médica.', certa: true, explicacao: 'Art. 24 da Lei nº 8.112/90. Sendo inviável a readaptação, o servidor será aposentado por incapacidade permanente.', baseLegal: 'Lei nº 8.112/1990, art. 24', variacoes: [{ enunciado: 'O estágio probatório do servidor federal tem duração de vinte e quatro meses.', certa: false, explicacao: 'O estágio probatório é de 36 meses, alinhado ao prazo de três anos da estabilidade constitucional.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-06',
      nome: 'Poderes administrativos: hierárquico, disciplinar, regulamentar e de polícia',
      teoria: `
## Visão geral
...
`,
      questoes: [
        { id: 'adm-b1-06-q1', enunciado: 'A delegação de competência de um titular a outro depende da existência de subordinação hierárquica.', certa: false, explicacao: 'A Lei nº 9.784/99 admite delegação ainda que não haja subordinação hierárquica. A hierarquia é indispensável apenas para a avocação. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 9.784/1999, arts. 12 e 15', variacoes: [{ enunciado: 'São indelegáveis a edição de atos normativos, a decisão de recursos administrativos e as matérias de competência exclusiva.', certa: true, explicacao: 'Correto — art. 13 da Lei nº 9.784/99.' }] },
        { id: 'adm-b1-06-q2', enunciado: 'Por meio do poder regulamentar, cabe à administração pública criar mecanismos de complementação das leis, a fim de possibilitar a sua efetiva aplicabilidade.', certa: true, explicacao: 'O poder regulamentar viabiliza a fiel execução da lei, sem inovar na ordem jurídica. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 84, IV', variacoes: [{ enunciado: 'O decreto de execução pode criar obrigações não previstas na lei que regulamenta, desde que necessárias à sua aplicação.', certa: false, explicacao: 'O decreto de execução não inova: apenas detalha a aplicação da lei. Criar obrigação exige lei.' }] },
        { id: 'adm-b1-06-q3', enunciado: 'O poder disciplinar alcança os servidores públicos e os particulares que possuam vínculo específico com a administração.', certa: true, explicacao: 'Sem vínculo específico, a atuação sancionatória se dá pelo poder de polícia, e não pelo disciplinar.', variacoes: [{ enunciado: 'A autoexecutoriedade permite à administração executar diretamente suas decisões, sendo atributo presente em todos os atos de polícia.', certa: false, explicacao: 'A executoriedade (meio direto) exige previsão legal ou situação de urgência; nem todo ato de polícia a possui — a cobrança de multa, por exemplo, depende de execução judicial.' }] },
        { id: 'adm-b1-06-q4', enunciado: 'Segundo o STF, as fases de consentimento e fiscalização do poder de polícia podem ser delegadas a pessoas jurídicas de direito privado integrantes da administração indireta.', certa: true, explicacao: 'As fases de ordem e sanção permanecem indelegáveis a particulares, por envolverem poder de império.', baseLegal: 'STF, RE 633.782, Tema 532', variacoes: [{ enunciado: 'A polícia administrativa incide sobre pessoas, enquanto a polícia judiciária incide sobre bens e atividades.', certa: false, explicacao: 'É o inverso: administrativa incide sobre bens, direitos e atividades; judiciária, sobre pessoas.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-07',
      nome: 'Ato administrativo: validade, eficácia, atributos, extinção e classificação',
      teoria: `
...
`,
      questoes: [
        { id: 'adm-b1-07-q1', enunciado: 'A competência, a finalidade e a forma são elementos sempre vinculados do ato administrativo, ao passo que o motivo e o objeto podem ser discricionários.', certa: true, explicacao: 'É a base do controle judicial: mesmo no ato discricionário, esses três elementos são plenamente controláveis.', variacoes: [{ enunciado: 'O mérito administrativo compreende o juízo de conveniência e oportunidade quanto à competência e à forma do ato.', certa: false, explicacao: 'O mérito recai sobre MOTIVO e OBJETO. Competência, finalidade e forma são vinculados.' }] },
        { id: 'adm-b1-07-q2', enunciado: 'Segundo a teoria dos motivos determinantes, a validade do ato administrativo vincula-se aos motivos declarados pela administração, ainda que a motivação não fosse obrigatória.', certa: true, explicacao: 'Declarado o motivo, ele passa a integrar a validade do ato: se falso ou inexistente, o ato é nulo.', variacoes: [{ enunciado: 'A presunção de legitimidade do ato administrativo é absoluta, não admitindo prova em contrário.', certa: false, explicacao: 'É presunção relativa (juris tantum): admite prova em contrário, apenas invertendo o ônus probatório.' }] },
        { id: 'adm-b1-07-q3', enunciado: 'A licença é ato administrativo vinculado e definitivo, ao passo que a autorização é discricionária e precária.', certa: true, explicacao: 'Quem preenche os requisitos tem direito à licença. A autorização pode ser revogada a qualquer tempo, em regra sem indenização.', variacoes: [{ enunciado: 'Admite-se a convalidação de atos administrativos com vício de finalidade, desde que ausente prejuízo a terceiros.', certa: false, explicacao: 'Só se convalidam vícios sanáveis de competência (não exclusiva) e de forma (não essencial). Finalidade, motivo e objeto são insanáveis.' }] },
        { id: 'adm-b1-07-q4', enunciado: 'A caducidade do ato administrativo ocorre quando norma jurídica superveniente torna inadmissível a situação antes permitida.', certa: true, explicacao: 'Distingue-se da cassação, que decorre do descumprimento de condições pelo beneficiário.', variacoes: [{ enunciado: 'Os atos administrativos vinculados podem ser revogados por razões de conveniência e oportunidade.', certa: false, explicacao: 'Atos vinculados não comportam revogação — apenas anulação, se ilegais.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-08',
      nome: 'Serviços públicos: conceito, classificação e delegação',
      teoria: `
## Conceito
...
`,
      questoes: [
        { id: 'adm-b1-08-q1', enunciado: 'A concessão administrativa se dá quando seu objeto é a prestação de serviço do qual a administração pública seja a usuária, ainda que indireta.', certa: true, explicacao: 'Definição legal da concessão administrativa, uma das modalidades de PPP. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 11.079/2004, art. 2º, §2º', variacoes: [{ enunciado: 'Na concessão patrocinada há, adicionalmente à tarifa cobrada dos usuários, contraprestação pecuniária do parceiro público.', certa: true, explicacao: 'Correto — art. 2º, §1º, da Lei nº 11.079/2004.' }] },
        { id: 'adm-b1-08-q2', enunciado: 'A concessão de serviço público somente pode ser outorgada a pessoa jurídica ou consórcio de empresas, ao passo que a permissão admite pessoa física.', certa: true, explicacao: 'É a distinção do art. 2º da Lei nº 8.987/95, ao lado da precariedade que caracteriza a permissão.', baseLegal: 'Lei nº 8.987/1995, art. 2º', variacoes: [{ enunciado: 'A autorização de serviço público é formalizada por contrato administrativo precedido de licitação.', certa: false, explicacao: 'A autorização é ato unilateral, discricionário e precário, dispensando licitação.' }] },
        { id: 'adm-b1-08-q3', enunciado: 'Não caracteriza descontinuidade do serviço público a interrupção, após aviso prévio, por inadimplemento do usuário, considerado o interesse da coletividade.', certa: true, explicacao: 'É a exceção expressa do art. 6º, §3º, da Lei nº 8.987/95, ao lado das razões de ordem técnica e de segurança.', baseLegal: 'Lei nº 8.987/1995, art. 6º, §3º', variacoes: [{ enunciado: 'A encampação consiste na extinção da concessão por inadimplemento do concessionário.', certa: false, explicacao: 'Inadimplemento do concessionário é CADUCIDADE. Encampação é a retomada por interesse público, com lei autorizativa e indenização prévia.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-09',
      nome: 'Controle da administração: administrativo, judicial e legislativo',
      teoria: `
## Classificações
...
`,
      questoes: [
        { id: 'adm-b1-09-q1', enunciado: 'O direito de petição, por meio do qual as pessoas podem formular postulações aos órgãos públicos, é um meio de controle administrativo.', certa: true, explicacao: 'É instrumento de controle popular exercido na própria via administrativa. Item cobrado na prova de 2022.', baseLegal: 'CF/88, art. 5º, XXXIV, "a"', variacoes: [{ enunciado: 'O recurso hierárquico impróprio, dirigido a autoridade de outra pessoa jurídica, independe de previsão legal expressa.', certa: false, explicacao: 'O recurso hierárquico impróprio DEPENDE de previsão legal. O próprio é que independe.' }] },
        { id: 'adm-b1-09-q2', enunciado: 'Compete ao Tribunal de Contas da União apreciar as contas anuais do Presidente da República, mediante parecer prévio, cabendo o julgamento ao Congresso Nacional.', certa: true, explicacao: 'O TCU emite parecer prévio em 60 dias; o julgamento é competência exclusiva do Congresso (art. 49, IX).', baseLegal: 'CF/88, arts. 71, I, e 49, IX', variacoes: [{ enunciado: 'Compete ao TCU julgar as contas do Presidente da República e dos demais administradores públicos.', certa: false, explicacao: 'O TCU julga as contas dos administradores em geral, mas quanto ao Presidente apenas emite parecer prévio.' }] },
        { id: 'adm-b1-09-q3', enunciado: 'O Poder Judiciário pode controlar a legalidade dos atos administrativos discricionários, inclusive quanto à razoabilidade e à proporcionalidade, sem substituir o mérito administrativo.', certa: true, explicacao: 'O controle recai sobre a legalidade em sentido amplo; a escolha de conveniência e oportunidade permanece com a Administração.', variacoes: [{ enunciado: 'O Brasil adota o sistema do contencioso administrativo, no qual as decisões administrativas fazem coisa julgada.', certa: false, explicacao: 'O Brasil adota a jurisdição UNA (sistema inglês): apenas o Judiciário produz coisa julgada.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'adm-b1-10-q1', enunciado: 'A responsabilidade civil do Estado por conduta comissiva de seus agentes é objetiva, fundada na teoria do risco administrativo, admitindo excludentes de nexo causal.', certa: true, explicacao: 'Exige-se conduta, dano e nexo causal, dispensada a prova de culpa. O risco administrativo admite excludentes; o integral, não.', baseLegal: 'CF/88, art. 37, §6º', variacoes: [{ enunciado: 'A teoria do risco integral, adotada como regra no Brasil, não admite excludentes de responsabilidade.', certa: false, explicacao: 'A regra é o risco ADMINISTRATIVO, que admite excludentes. O risco integral é excepcional (dano nuclear, ambiental).' }] },
        { id: 'adm-b1-10-q2', enunciado: 'Segundo o STF, a vítima de dano causado por agente público deve ajuizar a ação indenizatória contra o Estado, e não diretamente contra o agente.', certa: true, explicacao: 'É a teoria da dupla garantia (Tema 940): o agente só responde em ação regressiva, se houver dolo ou culpa.', baseLegal: 'STF, RE 1.027.633, Tema 940', variacoes: [{ enunciado: 'O agente público responde objetivamente perante o Estado na ação de regresso.', certa: false, explicacao: 'Na ação de regresso a responsabilidade do agente é SUBJETIVA: depende de comprovação de dolo ou culpa.' }] },
        { id: 'adm-b1-10-q3', enunciado: 'As concessionárias de serviço público respondem objetivamente pelos danos causados tanto a usuários quanto a não usuários do serviço.', certa: true, explicacao: 'Entendimento firmado pelo STF no RE 591.874. O Estado responde de forma subsidiária.', baseLegal: 'CF/88, art. 37, §6º; STF, RE 591.874', variacoes: [{ enunciado: 'A culpa concorrente da vítima exclui integralmente a responsabilidade civil do Estado.', certa: false, explicacao: 'A culpa concorrente apenas ATENUA a responsabilidade. A exclusão exige culpa EXCLUSIVA da vítima.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-11',
      nome: 'Lei nº 8.429/1992 (Improbidade Administrativa)',
      teoria: `
## Natureza
...
`,
      questoes: [
        { id: 'adm-b1-11-q1', enunciado: 'A voluntariedade do agente é suficiente para caracterizar a conduta ilícita como crime de improbidade administrativa.', certa: false, explicacao: 'Improbidade é ilícito CIVIL, não crime. E, após a Lei nº 14.230/2021, exige-se DOLO específico — a mera voluntariedade não basta. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.429/1992, art. 1º, §§1º a 3º', variacoes: [{ enunciado: 'Após a Lei nº 14.230/2021, não há modalidade culposa de ato de improbidade administrativa.', certa: true, explicacao: 'Correto. A reforma eliminou a modalidade culposa que existia no art. 10.' }] },
        { id: 'adm-b1-11-q2', enunciado: 'Os atos de improbidade que causam prejuízo ao erário exigem a comprovação de efetivo dano patrimonial.', certa: true, explicacao: 'A tipificação do art. 10 pressupõe perda patrimonial efetiva, ao contrário do enriquecimento ilícito e da violação de princípios.', baseLegal: 'Lei nº 8.429/1992, art. 10', variacoes: [{ enunciado: 'O rol de condutas que violam os princípios da administração pública, previsto no art. 11 da Lei nº 8.429/1992, é meramente exemplificativo.', certa: false, explicacao: 'Após a Lei nº 14.230/2021 o rol tornou-se TAXATIVO.' }] },
        { id: 'adm-b1-11-q3', enunciado: 'A ação por improbidade administrativa prescreve em oito anos, contados da ocorrência do fato ou, no caso de infrações permanentes, da cessação da permanência.', certa: true, explicacao: 'Prazo único do art. 23, com a redação da Lei nº 14.230/2021. O ressarcimento por ato doloso permanece imprescritível.', baseLegal: 'Lei nº 8.429/1992, art. 23; STF, Tema 897', variacoes: [{ enunciado: 'A legitimidade para propor a ação de improbidade administrativa é concorrente entre o Ministério Público e a pessoa jurídica interessada.', certa: false, explicacao: 'Após a Lei nº 14.230/2021 a legitimidade é EXCLUSIVA do Ministério Público; a pessoa jurídica pode habilitar-se como assistente.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'adm-b1-12',
      nome: 'Lei nº 9.784/1999 (Processo Administrativo)',
      teoria: `
## Alcance
...
`,
      questoes: [
        { id: 'adm-b1-12-q1', enunciado: 'A propositura de ação judicial com objeto idêntico ao do recurso administrativo importa renúncia ao direito de recorrer e desistência do recurso interposto.', certa: true, explicacao: 'Art. 63, §2º, da Lei nº 9.784/99 — regra cobrada na prova de 2022 no contexto do Conselho de Recursos da Previdência Social.', baseLegal: 'Lei nº 9.784/1999, art. 63, §2º', variacoes: [{ enunciado: 'É admitida a exigência de depósito prévio como condição de admissibilidade de recurso administrativo.', certa: false, explicacao: 'Vedação expressa do art. 56, §2º, e da Súmula Vinculante 21 do STF.' }] },
        { id: 'adm-b1-12-q2', enunciado: 'O direito da administração de anular os atos administrativos de que decorram efeitos favoráveis para os destinatários decai em cinco anos, contados da data em que foram praticados, salvo comprovada má-fé.', certa: true, explicacao: 'Art. 54 da Lei nº 9.784/99 — expressão do princípio da segurança jurídica.', baseLegal: 'Lei nº 9.784/1999, art. 54', variacoes: [{ enunciado: 'O prazo decadencial de cinco anos para anulação de atos favoráveis aplica-se mesmo quando comprovada a má-fé do beneficiário.', certa: false, explicacao: 'A má-fé afasta a decadência: nesse caso o ato pode ser anulado a qualquer tempo.' }] },
        { id: 'adm-b1-12-q3', enunciado: 'A falta de defesa técnica por advogado no processo administrativo disciplinar não ofende a Constituição.', certa: true, explicacao: 'É o teor da Súmula Vinculante 5 do STF. O art. 3º, IV, da Lei nº 9.784/99 assegura a faculdade, não a obrigatoriedade.', baseLegal: 'STF, Súmula Vinculante 5', variacoes: [{ enunciado: 'O prazo para interposição de recurso administrativo é de trinta dias, contados da ciência da decisão.', certa: false, explicacao: 'O prazo é de 10 dias. Os 30 dias são para a Administração DECIDIR o recurso.' }] },
        { id: 'adm-b1-12-q4', enunciado: 'Admite-se a reformatio in pejus no processo administrativo, desde que o recorrente seja cientificado para formular alegações antes da decisão.', certa: true, explicacao: 'Art. 64, parágrafo único, da Lei nº 9.784/99 — diferentemente do processo penal, o administrativo admite o agravamento.', baseLegal: 'Lei nº 9.784/1999, art. 64, parágrafo único', variacoes: [{ enunciado: 'O recurso administrativo tramita, no máximo, por três instâncias, salvo disposição legal diversa.', certa: true, explicacao: 'Correto — art. 57 da Lei nº 9.784/99.' }] },
      ],
      flashcards: [
