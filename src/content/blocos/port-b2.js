/**
 * Língua Portuguesa — Bloco 2: gramática e redação oficial
 */
export default {
  id: 'port-b2',
  materiaId: 'port',
  ...
  ordem: 2,
  objetivo: 'Crase, sintaxe, pontuação, concordância, regência, semântica e redação oficial.',
  topicos: [
    {
      id: 'port-b2-01',
...
`,
      questoes: [
        { id: 'port-b2-01-q1', enunciado: 'Não ocorre crase antes de palavras masculinas, de verbos e de pronomes pessoais.', certa: true, explicacao: 'Nesses casos falta o artigo feminino "a", que é uma das duas condições necessárias para a crase.', variacoes: [{ enunciado: 'Ocorre crase na expressão "andar à cavalo", por tratar-se de locução adverbial.', certa: false, explicacao: '"Cavalo" é masculino: não há artigo feminino a se fundir. Escreve-se "a cavalo".' }] },
        { id: 'port-b2-01-q2', enunciado: 'Nas locuções adverbiais femininas, como "às pressas" e "à noite", o emprego do sinal indicativo de crase é obrigatório.', certa: true, explicacao: 'Locuções adverbiais, prepositivas e conjuntivas femininas levam crase obrigatória, inclusive para evitar ambiguidade.', variacoes: [{ enunciado: 'O emprego do sinal indicativo de crase é facultativo antes de nomes próprios femininos e de pronomes possessivos femininos.', certa: true, explicacao: 'Correto — são dois dos três casos facultativos, ao lado da preposição "até".' }] },
        { id: 'port-b2-01-q3', enunciado: 'Em "Ele foi à Bahia e depois a Brasília", o emprego do sinal indicativo de crase está correto nas duas ocorrências.', certa: true, explicacao: 'Aplica-se o teste "voltei de/da": volta-se DA Bahia (com artigo, logo há crase) e DE Brasília (sem artigo, logo sem crase).', variacoes: [{ enunciado: 'Ocorre crase em "Refiro-me a aquele processo", devendo a expressão ser grafada "àquele".', certa: true, explicacao: 'Correto. O verbo referir-se exige a preposição "a", que se funde ao "a" inicial de "aquele".' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'port-b2-02-q1', enunciado: 'Na oração "Vendem-se casas na região", a partícula "se" funciona como pronome apassivador, e "casas" é o sujeito paciente.', certa: true, explicacao: 'Verbo transitivo direto + se = voz passiva sintética. Equivale a "casas são vendidas", com concordância obrigatória no plural.', variacoes: [{ enunciado: 'Na oração "Precisa-se de servidores", a partícula "se" é pronome apassivador e "servidores" é o sujeito.', certa: false, explicacao: '"Precisar de" é transitivo indireto: o "se" é índice de indeterminação do sujeito, e o verbo fica no singular.' }] },
        { id: 'port-b2-02-q2', enunciado: 'A oração adjetiva restritiva não é isolada por vírgulas, ao contrário da explicativa.', certa: true, explicacao: 'A restritiva delimita o antecedente e integra o sentido; a explicativa acrescenta informação acessória e vem entre vírgulas.', variacoes: [{ enunciado: 'A presença de vírgulas em uma oração adjetiva não altera o sentido do período.', certa: false, explicacao: 'Altera decisivamente: sem vírgulas restringe (só alguns); com vírgulas generaliza (todos).' }] },
        { id: 'port-b2-02-q3', enunciado: 'Em "a análise do processo", a expressão "do processo" é complemento nominal, pois o processo sofre a ação expressa pelo substantivo abstrato.', certa: true, explicacao: 'Sentido passivo → complemento nominal. Se fosse sentido ativo ("a decisão do juiz"), seria adjunto adnominal.', variacoes: [{ enunciado: 'Para distinguir o "que" conjunção integrante do "que" pronome relativo, pode-se testar a substituição por "o qual".', certa: true, explicacao: 'Correto. Se "o qual" couber, é pronome relativo (oração adjetiva); se não couber, é conjunção integrante (oração substantiva).' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'port-b2-03-q1', enunciado: 'É incorreto o emprego de vírgula para separar o sujeito do predicado, ainda que o sujeito seja constituído por expressão longa.', certa: true, explicacao: 'A extensão do sujeito não autoriza a vírgula. A separação só é legítima quando há termo intercalado entre duas vírgulas.', variacoes: [{ enunciado: 'Quando o sujeito é longo, admite-se o emprego de vírgula para separá-lo do verbo, facilitando a leitura.', certa: false, explicacao: 'Não se separa sujeito de predicado por vírgula, independentemente da extensão.' }] },
        { id: 'port-b2-03-q2', enunciado: 'O ponto e vírgula é adequado para separar itens de uma enumeração que já contenham vírgulas internas.', certa: true, explicacao: 'É o uso típico em incisos de textos legais, evitando ambiguidade entre os níveis de separação.', variacoes: [{ enunciado: 'Os dois-pontos podem introduzir enumeração, esclarecimento ou citação.', certa: true, explicacao: 'Correto — são as três funções básicas dos dois-pontos.' }] },
        { id: 'port-b2-03-q3', enunciado: 'O adjunto adverbial deslocado para o início do período, quando extenso, deve ser isolado por vírgula.', certa: true, explicacao: 'O deslocamento de adjunto adverbial extenso exige vírgula; se for curto, a vírgula é facultativa.', variacoes: [{ enunciado: 'É obrigatório o emprego de vírgula antes da conjunção "e" em todas as orações coordenadas.', certa: false, explicacao: 'Em regra não se usa vírgula antes de "e" aditivo com mesmo sujeito. Ela é admitida quando os sujeitos são diferentes ou há valor adversativo.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'port-b2-04',
      nome: 'Concordância nominal e verbal',
      teoria: `
...
`,
      questoes: [
        { id: 'port-b2-04-q1', enunciado: 'Na oração "Deve haver muitos processos pendentes", o verbo auxiliar permanece no singular porque o verbo principal é impessoal.', certa: true, explicacao: 'A impessoalidade de "haver" se transmite ao auxiliar da locução. "Devem haver" é erro clássico.', variacoes: [{ enunciado: 'Na oração "Haviam muitos segurados na fila", a concordância verbal está correta.', certa: false, explicacao: '"Haver" no sentido de existir é impessoal e permanece no singular: "Havia muitos segurados".' }] },
        { id: 'port-b2-04-q2', enunciado: 'Na frase "É proibida a entrada de pessoas não autorizadas", a flexão do adjetivo justifica-se pela presença do artigo antes do substantivo.', certa: true, explicacao: 'Com determinante, expressões como "é proibido", "é necessário" e "é bom" concordam. Sem determinante, ficam invariáveis: "É proibido entrada".', variacoes: [{ enunciado: 'Na frase "Seguem anexo as certidões solicitadas", a concordância nominal está correta.', certa: false, explicacao: '"Anexo" varia: "Seguem anexas as certidões". Invariável é apenas a locução "em anexo".' }] },
        { id: 'port-b2-04-q3', enunciado: 'Em "A maioria dos servidores compareceu à reunião", a concordância verbal está correta, admitindo-se também o plural.', certa: true, explicacao: 'Com expressões partitivas seguidas de plural, a concordância é facultativa: singular (com o núcleo) ou plural (com o especificador).', variacoes: [{ enunciado: 'Na frase "Ela estava meia cansada", a concordância nominal está correta.', certa: false, explicacao: '"Meio" com sentido de "um pouco" é advérbio e não varia: "meio cansada".' }] },
      ],
      flashcards: [
    ...
    {
      id: 'port-b2-05',
      nome: 'Regências nominal e verbal',
      teoria: `
## Conceito
...
`,
      questoes: [
        { id: 'port-b2-05-q1', enunciado: 'Na frase "O servidor aspira ao cargo de chefia", a regência do verbo está correta, uma vez que "aspirar", no sentido de almejar, é transitivo indireto.', certa: true, explicacao: '"Aspirar" no sentido de desejar rege a preposição "a". Sem preposição, significa inalar.', variacoes: [{ enunciado: 'Na frase "O projeto visa o aumento da arrecadação", a regência está correta, pois "visar" no sentido de ter por objetivo é transitivo direto.', certa: false, explicacao: '"Visar" com sentido de ter por objetivo é transitivo indireto: "visa ao aumento".' }] },
        { id: 'port-b2-05-q2', enunciado: 'Em "Assiste ao segurado o direito de recorrer", o verbo "assistir" está empregado no sentido de caber, exigindo a preposição "a".', certa: true, explicacao: 'No sentido de caber/pertencer, "assistir" é transitivo indireto. No sentido de auxiliar, é transitivo direto.', variacoes: [{ enunciado: 'Na frase "Prefiro estudar do que trabalhar", a regência do verbo preferir está correta.', certa: false, explicacao: 'O correto é "prefiro estudar A trabalhar", sem intensificadores como "mais" ou "do que".' }] },
        { id: 'port-b2-05-q3', enunciado: 'Na frase "Este é o processo a que me refiro", o emprego da preposição antes do pronome relativo é exigido pela regência do verbo "referir-se".', certa: true, explicacao: 'A preposição exigida pelo verbo da oração adjetiva antecede o pronome relativo. Omiti-la é erro frequente.', variacoes: [{ enunciado: 'A frase "Este é o assunto que discordo" está de acordo com a norma padrão.', certa: false, explicacao: '"Discordar" exige a preposição "de": "o assunto DE QUE discordo".' }] },
      ],
      flashcards: [
    ...
    {
      id: 'port-b2-06',
      nome: 'Significação das palavras',
      teoria: `
## Relações de sentido
...
`,
      questoes: [
        { id: 'port-b2-06-q1', enunciado: 'Os vocábulos "ratificar" e "retificar" são parônimos, significando, respectivamente, confirmar e corrigir.', certa: true, explicacao: 'Parônimos têm formas parecidas e sentidos distintos — par recorrente em provas de redação oficial.', variacoes: [{ enunciado: 'Os vocábulos "infligir" e "infringir" são sinônimos, ambos significando violar uma norma.', certa: false, explicacao: 'São parônimos: "infligir" é aplicar (pena); "infringir" é violar (norma).' }] },
        { id: 'port-b2-06-q2', enunciado: 'Na expressão "Li Machado de Assis", ocorre metonímia, pois o nome do autor substitui sua obra.', certa: true, explicacao: 'A metonímia opera por relação de contiguidade (autor pela obra, continente pelo conteúdo, marca pelo produto).', variacoes: [{ enunciado: 'A substituição de um termo por outro com base em relação de semelhança implícita caracteriza a metonímia.', certa: false, explicacao: 'Semelhança implícita é METÁFORA. A metonímia opera por contiguidade.' }] },
        { id: 'port-b2-06-q3', enunciado: 'Em textos oficiais deve predominar o sentido denotativo das palavras, dada a exigência de clareza e objetividade.', certa: true, explicacao: 'A linguagem oficial exige denotação, impessoalidade e precisão, evitando ambiguidade e sentido figurado.', variacoes: [{ enunciado: '"Benefício" é hipônimo de "aposentadoria", por ser termo mais específico.', certa: false, explicacao: 'É o inverso: "benefício" é o hiperônimo (mais geral) e "aposentadoria", o hipônimo (mais específico).' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'port-b2-07-q1', enunciado: 'A terceira edição do Manual de Redação da Presidência da República unificou o ofício, o aviso e o memorando em um único tipo de expediente, denominado ofício.', certa: true, explicacao: 'Essa unificação é uma das principais mudanças da 3ª edição: não há mais "aviso" nem "memorando" como espécies autônomas.', variacoes: [{ enunciado: 'O memorando permanece como expediente próprio para a comunicação entre unidades administrativas de um mesmo órgão.', certa: false, explicacao: 'O memorando foi absorvido pelo padrão ofício na 3ª edição do MRPR.' }] },
        { id: 'port-b2-07-q2', enunciado: 'O vocativo "Excelentíssimo Senhor" é reservado, na atual redação do Manual, ao Presidente da República.', certa: true, explicacao: 'Para as demais autoridades usa-se apenas "Senhor" seguido do cargo, ainda que o pronome de tratamento continue sendo Vossa Excelência.', variacoes: [{ enunciado: 'O pronome de tratamento "Vossa Senhoria" deve ser empregado nas comunicações dirigidas a particulares.', certa: false, explicacao: 'A 3ª edição abandonou "Vossa Senhoria": para particulares e demais servidores usa-se "Senhor" ou "Senhora".' }] },
        { id: 'port-b2-07-q3', enunciado: 'Os pronomes de tratamento exigem concordância verbal na terceira pessoa, ainda que se dirijam à segunda pessoa do discurso.', certa: true, explicacao: 'Verbos e possessivos vão para a 3ª pessoa; apenas os adjetivos concordam com o sexo da pessoa a quem se dirige.', variacoes: [{ enunciado: 'No padrão ofício, o fecho "Respeitosamente" é empregado nas comunicações dirigidas a autoridades de mesma hierarquia ou inferiores.', certa: false, explicacao: 'É o contrário: "Respeitosamente" para autoridades superiores; "Atenciosamente" para as de mesma hierarquia ou inferiores.' }] },
        { id: 'port-b2-07-q4', enunciado: 'A impessoalidade na redação oficial decorre do fato de que quem comunica é o Serviço Público, e não a pessoa do signatário.', certa: true, explicacao: 'Por isso não cabem opiniões pessoais nem marcas de subjetividade nos expedientes oficiais.', variacoes: [{ enunciado: 'A identificação do signatário no padrão ofício deve incluir linha de assinatura acima do nome.', certa: false, explicacao: 'O MRPR dispensa a linha de assinatura: constam apenas o nome em maiúsculas e o cargo.' }] },
      ],
      flashcards: [
