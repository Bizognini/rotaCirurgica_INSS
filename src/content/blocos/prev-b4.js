/**
 * Direito Previdenciário — Bloco 4: legislações especiais, LOAS e contagem recíproca
 * Tópicos pontuais: decoram-se rápido, mas caem com frequência.
 */
export default {
  id: 'prev-b4',
  materiaId: 'prev',
...
`,
      questoes: [
        { id: 'prev-b4-01-q1', enunciado: 'A pensão especial devida aos portadores da síndrome de talidomida não é acumulável com rendimento ou remuneração pagos pela União, ressalvado o direito de opção.', certa: true, explicacao: 'É a regra do art. 4º da Lei nº 7.070/1982. A exceção prevista em lei é a indenização por dano moral, que pode ser acumulada. Item cobrado (invertido) na prova de 2022.', baseLegal: 'Lei nº 7.070/1982, art. 4º; Lei nº 12.190/2010', variacoes: [{ enunciado: 'A indenização por dano moral concedida por lei específica aos portadores da síndrome de talidomida pode ser acumulada com a pensão especial.', certa: true, explicacao: 'Correto — é a exceção expressa à regra da inacumulabilidade.' }] },
        { id: 'prev-b4-01-q2', enunciado: 'O valor da pensão especial da síndrome de talidomida é obtido pela multiplicação do número de pontos, atribuídos conforme os tipos de incapacidade, por um valor fixado em lei.', certa: true, explicacao: 'A pontuação considera incapacidade para o trabalho, locomoção, deambulação e atividades da vida diária.', baseLegal: 'Lei nº 7.070/1982, art. 1º, §1º', variacoes: [{ enunciado: 'A pensão especial da síndrome de talidomida corresponde a valor fixo de um salário mínimo, independentemente do grau de incapacidade.', certa: false, explicacao: 'O valor é variável, calculado por pontuação conforme os tipos de incapacidade.' }] },
        { id: 'prev-b4-01-q3', enunciado: 'A concessão da pensão especial aos portadores da síndrome de talidomida depende de prévia contribuição ao Regime Geral de Previdência Social.', certa: false, explicacao: 'É benefício indenizatório custeado pelo Tesouro Nacional, independente de qualquer vínculo contributivo.', baseLegal: 'Lei nº 7.070/1982', variacoes: [{ enunciado: 'A pensão especial da talidomida tem natureza indenizatória e é custeada pelo Tesouro Nacional.', certa: true, explicacao: 'Correto — não é benefício previdenciário contributivo.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-02-q1', enunciado: 'Os seringueiros que trabalharam nos seringais da Amazônia durante a Segunda Guerra Mundial têm direito a pensão mensal vitalícia de dois salários mínimos, independentemente de possuírem meios de subsistência.', certa: false, explicacao: 'A lei exige a comprovação de que o beneficiário NÃO possui meios para a própria subsistência e a de sua família. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 7.986/1989, art. 1º; ADCT, art. 54', variacoes: [{ enunciado: 'A pensão especial dos seringueiros corresponde a dois salários mínimos e exige a comprovação de carência econômica do beneficiário.', certa: true, explicacao: 'Correto — valor de 2 salários mínimos e hipossuficiência como requisito.' }] },
        { id: 'prev-b4-02-q2', enunciado: 'A pensão especial dos seringueiros estende-se aos seus dependentes e é custeada pelo Tesouro Nacional.', certa: true, explicacao: 'Trata-se de benefício indenizatório, sem contribuição prévia, operacionalizado pelo INSS.', baseLegal: 'Lei nº 7.986/1989', variacoes: [{ enunciado: 'A pensão especial dos seringueiros é custeada pelo Fundo do Regime Geral de Previdência Social e exige carência de 180 contribuições.', certa: false, explicacao: 'Não é benefício contributivo: independe de carência e é custeada pelo Tesouro Nacional.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-03-q1', enunciado: 'A pensão especial devida aos ex-combatentes da Segunda Guerra Mundial e a seus dependentes corresponde à pensão militar deixada por segundo-tenente das Forças Armadas.', certa: true, explicacao: 'Literalidade do art. 1º da Lei nº 8.059/1990. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.059/1990, art. 1º; ADCT, art. 53', variacoes: [{ enunciado: 'A pensão especial de ex-combatente corresponde à pensão militar deixada por coronel das Forças Armadas.', certa: false, explicacao: 'O parâmetro legal é a pensão de SEGUNDO-TENENTE.' }] },
        { id: 'prev-b4-03-q2', enunciado: 'É vedada a acumulação da pensão especial de ex-combatente com outra pensão deixada pelo mesmo instituidor, ressalvado o direito de opção.', certa: true, explicacao: 'Regra expressa da Lei nº 8.059/1990, que preserva a escolha pelo benefício mais vantajoso.', baseLegal: 'Lei nº 8.059/1990, art. 30', variacoes: [{ enunciado: 'A percepção da pensão especial de ex-combatente impede o recebimento de aposentadoria do RGPS pelo próprio ex-combatente.', certa: false, explicacao: 'Os benefícios têm fatos geradores distintos; a vedação é à acumulação de pensões do mesmo instituidor.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-04-q1', enunciado: 'A pensão especial concedida às vítimas de hemodiálise de Caruaru não será transmitida aos seus sucessores.', certa: true, explicacao: 'A intransmissibilidade é característica expressa dessa pensão — e o contraste com o Césio-137, que é transmissível, é o ponto que a banca explora. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 9.422/1996, art. 2º', variacoes: [{ enunciado: 'A pensão especial das vítimas de hemodiálise de Caruaru transmite-se ao cônjuge sobrevivente e aos herdeiros do beneficiário.', certa: false, explicacao: 'Essa é a regra da pensão do Césio-137 (Lei nº 9.425/1996). A de Caruaru é intransmissível.' }] },
        { id: 'prev-b4-04-q2', enunciado: 'A pensão especial das vítimas de hemodiálise de Caruaru é custeada pelo Tesouro Nacional e independe de contribuição prévia à previdência social.', certa: true, explicacao: 'Tem natureza indenizatória, sem exigência de vínculo contributivo.', baseLegal: 'Lei nº 9.422/1996', variacoes: [{ enunciado: 'A percepção da pensão especial de Caruaru impede o recebimento de qualquer benefício previdenciário decorrente de contribuição própria da vítima.', certa: false, explicacao: 'A inacumulabilidade alcança indenizações da União pelos mesmos fatos, não os benefícios previdenciários contributivos.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-05-q1', enunciado: 'A pensão especial concedida às vítimas do acidente com césio-137 ocorrido em Goiânia é transmissível ao cônjuge sobrevivente ou aos herdeiros, em caso de morte do beneficiário.', certa: true, explicacao: 'É a característica que distingue essa pensão da de Caruaru, que é intransmissível. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 9.425/1996, art. 2º, §1º', variacoes: [{ enunciado: 'A pensão especial das vítimas do césio-137 é personalíssima e extingue-se com a morte do beneficiário.', certa: false, explicacao: 'Ela é transmissível ao cônjuge/companheiro sobrevivente e, na falta, aos herdeiros.' }] },
        { id: 'prev-b4-05-q2', enunciado: 'A pensão especial das vítimas do césio-137 exige contribuição prévia ao RGPS e submete-se a carência de doze contribuições.', certa: false, explicacao: 'É benefício indenizatório, custeado pelo Tesouro Nacional, que independe de contribuição e de carência.', baseLegal: 'Lei nº 9.425/1996', variacoes: [{ enunciado: 'A pensão vitalícia das vítimas do césio-137 é custeada pelo Tesouro Nacional e reajustada pelos mesmos índices dos benefícios do RGPS.', certa: true, explicacao: 'Correto — natureza indenizatória e reajuste vinculado aos índices dos benefícios previdenciários.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b4-06',
      nome: 'Aposentadoria e pensão excepcional ao anistiado político (Lei 10.559/2002)',
      teoria: `
## Fundamento
...
`,
      questoes: [
        { id: 'prev-b4-06-q1', enunciado: 'O regime do anistiado político compreende o direito à reparação econômica de caráter indenizatório, sendo vedadas a readmissão e a promoção na inatividade.', certa: false, explicacao: 'O regime assegura justamente a reintegração dos servidores e empregados públicos punidos e as promoções devidas. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 10.559/2002, art. 1º', variacoes: [{ enunciado: 'O regime do anistiado político assegura a contagem, para todos os efeitos, do tempo em que o interessado esteve compelido ao afastamento de suas atividades profissionais.', certa: true, explicacao: 'Correto — art. 1º, III, da Lei nº 10.559/2002.' }] },
        { id: 'prev-b4-06-q2', enunciado: 'A reparação econômica em prestação única ao anistiado político corresponde a trinta salários mínimos por ano de punição, observado teto legal.', certa: true, explicacao: 'É a regra do art. 4º da Lei nº 10.559/2002, com teto de R$ 100.000,00.', baseLegal: 'Lei nº 10.559/2002, art. 4º', variacoes: [{ enunciado: 'É permitida a acumulação de mais de uma reparação econômica pelo mesmo período de punição.', certa: false, explicacao: 'É vedada a acumulação de reparações de mesma natureza pelo mesmo fato, ressalvado o direito de opção.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b4-07',
      nome: 'Pensão especial às pessoas atingidas pela hanseníase (Lei 11.520/2007)',
      teoria: `
## Contexto
...
`,
      questoes: [
        { id: 'prev-b4-07-q1', enunciado: 'A pensão especial concedida às pessoas atingidas pela hanseníase, ressalvado o direito de opção, não é acumulável com indenização que a União venha a pagar em decorrência de responsabilização civil sobre os mesmos fatos, mas não impede a fruição de benefício previdenciário.', certa: true, explicacao: 'É a dupla regra da Lei nº 11.520/2007: veda a dupla reparação pelo mesmo fato, mas preserva os benefícios contributivos. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 11.520/2007, arts. 1º e 2º', variacoes: [{ enunciado: 'A percepção da pensão especial por pessoa atingida pela hanseníase impede o recebimento de aposentadoria do RGPS.', certa: false, explicacao: 'A lei é expressa: a pensão não impede a fruição de benefício previdenciário.' }] },
        { id: 'prev-b4-07-q2', enunciado: 'A pensão especial da Lei nº 11.520/2007 é devida às pessoas submetidas a isolamento e internação compulsórios em hospitais-colônia até 31 de dezembro de 1986.', certa: true, explicacao: 'É o recorte temporal da lei, que exige comprovação da internação compulsória e requerimento do interessado.', baseLegal: 'Lei nº 11.520/2007, art. 1º', variacoes: [{ enunciado: 'A pensão especial das pessoas atingidas pela hanseníase é transferível aos herdeiros em caso de falecimento do beneficiário.', certa: false, explicacao: 'A pensão é vitalícia e INTRANSFERÍVEL.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-08-q1', enunciado: 'A pensão especial destinada às crianças com síndrome congênita do zika vírus, nascidas entre 1º de janeiro de 2015 e 31 de dezembro de 2019 e beneficiárias do BPC, é mensal, vitalícia e intransferível, no valor de um salário mínimo.', certa: true, explicacao: 'Reúne os quatro atributos da Lei nº 13.985/2020 e o recorte temporal. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 13.985/2020, arts. 1º e 2º', variacoes: [{ enunciado: 'A pensão especial da síndrome congênita do zika vírus é temporária e cessa quando o beneficiário completa dezoito anos.', certa: false, explicacao: 'A pensão é VITALÍCIA, não temporária.' }] },
        { id: 'prev-b4-08-q2', enunciado: 'É permitida a acumulação da pensão especial da síndrome congênita do zika vírus com o benefício de prestação continuada.', certa: false, explicacao: 'O recebimento da pensão especial implica a suspensão do BPC — não há acumulação, sendo assegurado o direito de opção.', baseLegal: 'Lei nº 13.985/2020, art. 3º', variacoes: [{ enunciado: 'A pensão especial da Lei nº 13.985/2020 independe de contribuição prévia e é custeada pelo Tesouro Nacional.', certa: true, explicacao: 'Correto — natureza indenizatória, sem carência e sem exigência contributiva.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-09-q1', enunciado: 'O seguro-desemprego concedido durante o período de defeso ao pescador profissional artesanal é transferível a outrem.', certa: false, explicacao: 'O seguro-defeso é pessoal e intransferível, conforme expressa previsão legal. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 10.779/2003, art. 1º, §5º', variacoes: [{ enunciado: 'O seguro-defeso é pessoal e intransferível, no valor de um salário mínimo mensal.', certa: true, explicacao: 'Correto — é a regra da Lei nº 10.779/2003.' }] },
        { id: 'prev-b4-09-q2', enunciado: 'Para fazer jus ao seguro-defeso, o pescador artesanal não pode estar em gozo de benefício de prestação continuada da previdência ou da assistência social, excetuados o auxílio-acidente e a pensão por morte.', certa: true, explicacao: 'É a regra de não acumulação do art. 2º da Lei nº 10.779/2003, com as duas exceções expressas.', baseLegal: 'Lei nº 10.779/2003, art. 2º, §2º', variacoes: [{ enunciado: 'O seguro-defeso é custeado pelo Fundo do Regime Geral de Previdência Social.', certa: false, explicacao: 'É custeado pelo FAT (Fundo de Amparo ao Trabalhador), embora operacionalizado pelo INSS.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-10-q1', enunciado: 'A assistência social é regida pelo princípio da supremacia das exigências de rentabilidade econômica sobre o atendimento às necessidades sociais.', certa: false, explicacao: 'O princípio é exatamente o inverso: supremacia do atendimento às necessidades sociais sobre as exigências de rentabilidade econômica. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.742/1993, art. 4º, I', variacoes: [{ enunciado: 'Constitui princípio da assistência social a supremacia do atendimento às necessidades sociais sobre as exigências de rentabilidade econômica.', certa: true, explicacao: 'Correto — art. 4º, I, da LOAS.' }] },
        { id: 'prev-b4-10-q2', enunciado: 'A descentralização político-administrativa para os estados, o Distrito Federal e os municípios, com comando único em cada esfera, é diretriz da organização da assistência social.', certa: true, explicacao: 'É a primeira diretriz do art. 5º da LOAS, em consonância com o art. 204, I, da CF/88.', baseLegal: 'Lei nº 8.742/1993, art. 5º, I; CF/88, art. 204, I', variacoes: [{ enunciado: 'A primazia da responsabilidade pela condução da política de assistência social é das entidades beneficentes privadas.', certa: false, explicacao: 'A primazia é do ESTADO, em cada esfera de governo (art. 5º, III, da LOAS).' }] },
        { id: 'prev-b4-10-q3', enunciado: 'A assistência social será prestada a quem dela necessitar, independentemente de contribuição à seguridade social.', certa: true, explicacao: 'Literalidade do art. 203 da CF/88 e do art. 1º da LOAS — o traço que a distingue da previdência.', baseLegal: 'CF/88, art. 203; Lei nº 8.742/1993, art. 1º', variacoes: [{ enunciado: 'O acesso aos benefícios assistenciais depende do cumprimento de carência mínima de doze contribuições.', certa: false, explicacao: 'A assistência social independe de contribuição e, por consequência, de carência.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-11-q1', enunciado: 'Terão direito ao benefício de prestação continuada a pessoa com deficiência ou a pessoa idosa com renda familiar mensal per capita igual ou inferior a um quarto do salário mínimo, observados os demais critérios de elegibilidade.', certa: true, explicacao: 'É o critério objetivo do art. 20, §3º, da LOAS, com possibilidade de ampliação até 1/2 salário mínimo pela Lei nº 14.176/2021. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.742/1993, art. 20, §3º', variacoes: [{ enunciado: 'A idade mínima para concessão do BPC à pessoa idosa é de sessenta anos.', certa: false, explicacao: 'A idade mínima do BPC é 65 anos. Os 60 anos definem "pessoa idosa" para o Estatuto do Idoso, mas não para o BPC.' }] },
        { id: 'prev-b4-11-q2', enunciado: 'Compete ao INSS a operacionalização do benefício de prestação continuada.', certa: true, explicacao: 'Embora o BPC seja assistencial e custeado pelo FNAS, sua concessão e manutenção cabem ao INSS. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.742/1993, art. 20, §6º; Decreto nº 6.214/2007', variacoes: [{ enunciado: 'O benefício de prestação continuada gera direito ao abono anual (décimo terceiro) e à pensão por morte aos dependentes.', certa: false, explicacao: 'O BPC não gera 13º nem pensão por morte: é intransferível e cessa com a morte do beneficiário.' }] },
        { id: 'prev-b4-11-q3', enunciado: 'Considera-se pessoa com deficiência, para fins do BPC, aquela que tem impedimento de longo prazo, de no mínimo dois anos, de natureza física, mental, intelectual ou sensorial.', certa: true, explicacao: 'É a definição do art. 20, §§2º e 10, da LOAS, alinhada à Convenção sobre os Direitos das Pessoas com Deficiência.', baseLegal: 'Lei nº 8.742/1993, art. 20, §§2º e 10', variacoes: [{ enunciado: 'O benefício de prestação continuada exige carência de cento e oitenta contribuições mensais.', certa: false, explicacao: 'O BPC é assistencial: independe de contribuição e de carência.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-12-q1', enunciado: 'O pagamento do auxílio-inclusão não será acumulado com o pagamento do benefício de prestação continuada.', certa: true, explicacao: 'O auxílio-inclusão substitui o BPC durante o exercício de atividade remunerada. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 8.742/1993, art. 26-A', variacoes: [{ enunciado: 'O auxílio-inclusão pode ser acumulado com a remuneração decorrente do trabalho da pessoa com deficiência.', certa: true, explicacao: 'Correto — essa acumulação é justamente a finalidade do benefício.' }] },
        { id: 'prev-b4-12-q2', enunciado: 'O valor do auxílio-inclusão corresponde a cinquenta por cento do valor do benefício de prestação continuada.', certa: true, explicacao: 'Corresponde a meio salário mínimo, somado à remuneração do trabalho.', baseLegal: 'Lei nº 8.742/1993, art. 26-A, §3º', variacoes: [{ enunciado: 'O auxílio-inclusão é devido à pessoa com deficiência que passe a exercer atividade remunerada com remuneração de até cinco salários mínimos.', certa: false, explicacao: 'O limite de remuneração é de 2 salários mínimos.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b4-13',
      nome: 'Decreto nº 6.214/2007 (Regulamento do BPC)',
      teoria: `
## Função
...
`,
      questoes: [
        { id: 'prev-b4-13-q1', enunciado: 'A avaliação da deficiência para fins de concessão do BPC é exclusivamente médica, realizada por perito do INSS.', certa: false, explicacao: 'A avaliação é médica E social (biopsicossocial), realizada por médicos peritos e assistentes sociais do INSS.', baseLegal: 'Decreto nº 6.214/2007, art. 16; Lei nº 8.742/1993, art. 20, §6º', variacoes: [{ enunciado: 'A avaliação da deficiência para o BPC considera impedimentos nas funções e estruturas do corpo, fatores socioambientais, psicológicos e pessoais.', certa: true, explicacao: 'Correto — é o modelo biopsicossocial adotado pelo regulamento.' }] },
        { id: 'prev-b4-13-q2', enunciado: 'O benefício de prestação continuada deve ser revisto a cada dois anos para avaliação da continuidade das condições que lhe deram origem.', certa: true, explicacao: 'É a revisão bienal prevista no art. 21 da LOAS e detalhada pelo Decreto nº 6.214/2007.', baseLegal: 'Lei nº 8.742/1993, art. 21; Decreto nº 6.214/2007', variacoes: [{ enunciado: 'O valor do BPC não recebido em vida pelo beneficiário é pago aos seus herdeiros.', certa: true, explicacao: 'Correto. Isso não configura transmissão do benefício, que é intransferível.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-14-q1', enunciado: 'O regime próprio de previdência social abrange exclusivamente os servidores titulares de cargo efetivo do ente federativo que o instituiu.', certa: true, explicacao: 'O art. 40, §13, da CF/88 vincula ao RGPS os ocupantes de cargo temporário, de emprego público e exclusivamente de cargo em comissão.', baseLegal: 'CF/88, art. 40, caput e §13', variacoes: [{ enunciado: 'O servidor público titular de cargo efetivo de município que não instituiu regime próprio é segurado obrigatório do RGPS.', certa: true, explicacao: 'Correto. Sem RPPS instituído, o servidor efetivo vincula-se ao RGPS. Item cobrado na prova de 2022.' }] },
        { id: 'prev-b4-14-q2', enunciado: 'Após a EC nº 103/2019, é vedada a instituição de novos regimes próprios de previdência social pelos entes federativos.', certa: true, explicacao: 'A emenda vedou a criação de novos RPPS, permitindo apenas a manutenção dos já existentes, com unidade gestora única.', baseLegal: 'CF/88, art. 40, §22 (EC nº 103/2019)', variacoes: [{ enunciado: 'É permitida a existência de mais de um regime próprio de previdência social e de mais de uma unidade gestora por ente federativo.', certa: false, explicacao: 'A Constituição veda expressamente ambas as hipóteses.' }] },
        { id: 'prev-b4-14-q3', enunciado: 'Compete ao Conselho de Recursos da Previdência Social julgar os recursos interpostos contra decisões proferidas em processos de supervisão e de fiscalização de regimes próprios de previdência social.', certa: true, explicacao: 'A competência do CRPS foi ampliada para alcançar esses processos. Item cobrado na prova de 2022.', baseLegal: 'Decreto nº 3.048/99, art. 303', variacoes: [{ enunciado: 'É assegurada a contagem recíproca do tempo de contribuição entre o RGPS e os regimes próprios, com compensação financeira entre eles.', certa: true, explicacao: 'Correto — art. 201, §9º, da CF/88.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-15-q1', enunciado: 'É vedada a emissão de certidão de tempo de contribuição referente a período já utilizado para concessão de aposentadoria em qualquer regime previdenciário.', certa: true, explicacao: 'É a vedação central: o mesmo tempo não pode ser aproveitado duas vezes. Foi justamente a distinção cobrada na prova de 2022.', baseLegal: 'Decreto nº 3.048/99, art. 130; Lei nº 8.213/91, art. 96', variacoes: [{ enunciado: 'É admitida a emissão de certidão de tempo de contribuição com contagem em dobro de períodos de licença-prêmio não gozada.', certa: false, explicacao: 'É vedada a contagem de tempo fictício e a contagem com acréscimos (CF, art. 201, §14).' }] },
        { id: 'prev-b4-15-q2', enunciado: 'A certidão de tempo de contribuição pode ser cancelada a pedido do interessado, desde que não tenha sido utilizada para a concessão de benefício em outro regime.', certa: true, explicacao: 'O cancelamento exige a devolução da via original e a comprovação de que o tempo não foi averbado com aproveitamento.', baseLegal: 'Decreto nº 3.048/99, art. 130', variacoes: [{ enunciado: 'A emissão da certidão de tempo de contribuição pelo INSS independe da regularização de contribuições em atraso do contribuinte individual.', certa: false, explicacao: 'As contribuições em atraso devem estar indenizadas para que o período seja certificado.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'prev-b4-16',
      nome: 'Contagem recíproca de tempo de contribuição',
      teoria: `
...
`,
      questoes: [
        { id: 'prev-b4-16-q1', enunciado: 'Para efeito de contagem recíproca, é vedada a contagem de tempo de serviço público concomitante com tempo de atividade privada.', certa: true, explicacao: 'O art. 96, II, da Lei nº 8.213/91 impede a dupla contagem do mesmo período: tempo concomitante conta uma vez só.', baseLegal: 'Lei nº 8.213/91, art. 96, II', variacoes: [{ enunciado: 'É admitida a contagem recíproca de tempo de contribuição fictício, desde que reconhecido por lei do ente federativo.', certa: false, explicacao: 'A vedação ao tempo fictício é constitucional (art. 201, §14) e legal (art. 96, IV).' }] },
        { id: 'prev-b4-16-q2', enunciado: 'O segurado que recolheu contribuições pelo plano simplificado pode utilizar esse tempo para contagem recíproca independentemente de complementação.', certa: false, explicacao: 'O plano simplificado (11% ou 5%) exclui a contagem recíproca, salvo complementação da diferença de alíquota com juros.', baseLegal: 'Lei nº 8.212/91, art. 21, §§2º e 3º', variacoes: [{ enunciado: 'É assegurada a contagem recíproca do tempo de contribuição entre o RGPS e os regimes próprios, com compensação financeira entre os regimes.', certa: true, explicacao: 'Correto — art. 201, §9º, da CF/88.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-17-q1', enunciado: 'A compensação financeira entre os regimes de previdência será realizada exclusivamente na contagem recíproca de tempo de contribuição não concomitante utilizado na concessão da aposentadoria.', certa: true, explicacao: 'Reúne as três condições da Lei nº 9.796/1999: contagem recíproca, tempo não concomitante e efetiva utilização na concessão. Item cobrado na prova de 2022.', baseLegal: 'Lei nº 9.796/1999, art. 1º; CF/88, art. 201, §9º', variacoes: [{ enunciado: 'A compensação previdenciária é devida ainda que o tempo cedido pelo regime de origem não tenha sido utilizado na concessão da aposentadoria.', certa: false, explicacao: 'Só há compensação sobre tempo efetivamente utilizado na concessão do benefício.' }] },
        { id: 'prev-b4-17-q2', enunciado: 'Denomina-se regime instituidor aquele que concede a aposentadoria mediante contagem de tempo cedido por outro regime previdenciário.', certa: true, explicacao: 'O instituidor concede e paga; o regime de origem recebeu as contribuições e reembolsa a fração correspondente.', baseLegal: 'Lei nº 9.796/1999, art. 2º', variacoes: [{ enunciado: 'A compensação previdenciária reduz o valor do benefício recebido pelo segurado, na proporção do tempo cedido.', certa: false, explicacao: 'A compensação é acerto de contas ENTRE REGIMES e não afeta o valor recebido pelo segurado.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-18-q1', enunciado: 'A Instrução Normativa PRES/INSS nº 128/2022 pode estabelecer requisitos para concessão de benefícios não previstos em lei, por consolidar os procedimentos internos do INSS.', certa: false, explicacao: 'Instrução normativa é fonte formal secundária: uniformiza a aplicação da lei, mas não inova na ordem jurídica.', baseLegal: 'CF/88, art. 5º, II; IN PRES/INSS nº 128/2022', variacoes: [{ enunciado: 'A IN PRES/INSS nº 128/2022 possui hierarquia inferior ao Decreto nº 3.048/1999.', certa: true, explicacao: 'Correto. A ordem é: CF/EC → leis → decreto regulamentar → instrução normativa.' }] },
        { id: 'prev-b4-18-q2', enunciado: 'Os dados constantes do Cadastro Nacional de Informações Sociais valem como prova de filiação, de tempo de contribuição e de salários de contribuição.', certa: true, explicacao: 'É a regra do art. 29-A da Lei nº 8.213/91, detalhada pela IN. Havendo divergência, o segurado pode requerer o acerto com documentos.', baseLegal: 'Lei nº 8.213/91, art. 29-A', variacoes: [{ enunciado: 'A justificação administrativa pode suprir a falta de documento exclusivamente por meio de prova testemunhal, dispensado o início de prova material.', certa: false, explicacao: 'A JA não produz efeito sem início de prova material — no caso do tempo rural, é o teor da Súmula 149 do STJ.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-19-q1', enunciado: 'A atuação do servidor público como agente de desenvolvimento social pressupõe que ele compreenda sua função como mediação entre o Estado e o cidadão, contribuindo para a efetivação de direitos sociais.', certa: true, explicacao: 'É o núcleo do conceito: a função pública tem dimensão transformadora, e não apenas burocrática.', baseLegal: 'CF/88, arts. 1º, III, e 3º', variacoes: [{ enunciado: 'A função do servidor público limita-se ao cumprimento formal das tarefas previstas em regulamento, sem dimensão social.', certa: false, explicacao: 'O servidor atua como agente de desenvolvimento social, com dimensões técnica, ética, social e institucional.' }] },
        { id: 'prev-b4-19-q2', enunciado: 'É dever do servidor público ser cortês, ter urbanidade e atenção, respeitando a capacidade e as limitações individuais dos usuários, sem qualquer espécie de preconceito.', certa: true, explicacao: 'Dever fundamental do Código de Ética (Decreto nº 1.171/1994, inciso XIV, alínea "c").', baseLegal: 'Decreto nº 1.171/1994, XIV, "c"', variacoes: [{ enunciado: 'O servidor pode deixar de participar de estudos voltados à melhoria do exercício de suas funções, por não se tratar de dever fundamental.', certa: false, explicacao: 'Participar desses estudos é dever fundamental expresso (inciso XIV, alínea "j"). Item cobrado na prova de 2022.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'prev-b4-20-q1', enunciado: 'Segundo a Organização Mundial da Saúde, saúde é o estado de completo bem-estar físico, mental e social, e não apenas a ausência de doença.', certa: true, explicacao: 'É o conceito ampliado de saúde, incorporado pela CF/88 ao tratar a saúde como direito de todos e dever do Estado.', baseLegal: 'CF/88, art. 196; conceito da OMS', variacoes: [{ enunciado: 'Considera-se saudável o servidor que não apresenta doença diagnosticada, independentemente de suas condições psicossociais.', certa: false, explicacao: 'O conceito de saúde é ampliado: abrange bem-estar físico, mental e social.' }] },
        { id: 'prev-b4-20-q2', enunciado: 'A readaptação prevista na Lei nº 8.112/1990 consiste na investidura do servidor em cargo de atribuições e responsabilidades compatíveis com a limitação sofrida em sua capacidade física ou mental, verificada em inspeção médica.', certa: true, explicacao: 'É a definição do art. 24 da Lei nº 8.112/90. Sendo inviável a readaptação, o servidor será aposentado por incapacidade permanente.', baseLegal: 'Lei nº 8.112/1990, art. 24', variacoes: [{ enunciado: 'A síndrome de burnout não é reconhecida como fenômeno relacionado ao trabalho.', certa: false, explicacao: 'O burnout é reconhecido pela OMS como fenômeno ocupacional e integra a lista brasileira de doenças relacionadas ao trabalho.' }] },
      ],
      flashcards: [
