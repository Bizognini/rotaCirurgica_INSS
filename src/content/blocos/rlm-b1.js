/**
 * Raciocínio Lógico-Matemático — bloco único
 */
export default {
  id: 'rlm-b1',
  materiaId: 'rlm',
  nome: 'Bloco único — RLM',
  ordem: 1,
  objetivo: 'Lógica proposicional, tabela-verdade, conjuntos e porcentagem.',
  topicos: [
    {
      id: 'rlm-b1-01',
      nome: 'Proposições, valores lógicos e sentenças abertas',
      teoria: `
## Proposição
...
`,
      questoes: [
        { id: 'rlm-b1-01-q1', enunciado: 'Uma sentença que contenha variável cujo valor não esteja definido não constitui proposição lógica.', certa: true, explicacao: 'Trata-se de sentença aberta: só se torna proposição quando a variável é substituída ou quantificada. Conceito cobrado na prova de 2022.', variacoes: [{ enunciado: 'Sentenças interrogativas e imperativas podem ser classificadas como proposições, desde que se refiram a fatos verificáveis.', certa: false, explicacao: 'Apenas sentenças DECLARATIVAS podem ser proposições. Perguntas e ordens jamais são.' }] },
        { id: 'rlm-b1-01-q2', enunciado: 'A negação da proposição "Todos os servidores compareceram à reunião" é "Algum servidor não compareceu à reunião".', certa: true, explicacao: 'Negar o quantificador universal afirmativo produz o existencial negativo — e não "nenhum servidor compareceu".', variacoes: [{ enunciado: 'A negação de "Todos os segurados contribuíram" é "Nenhum segurado contribuiu".', certa: false, explicacao: 'A negação correta é "Algum segurado NÃO contribuiu". "Nenhum" é uma afirmação mais forte, não a negação.' }] },
        { id: 'rlm-b1-01-q3', enunciado: 'Pelo princípio do terceiro excluído, toda proposição é verdadeira ou falsa, não havendo outra possibilidade.', certa: true, explicacao: 'É um dos três princípios da lógica clássica, ao lado da identidade e da não contradição.', variacoes: [{ enunciado: 'A aplicação de um quantificador a uma sentença aberta a mantém sem valor lógico definido.', certa: false, explicacao: 'Ao contrário: quantificar uma sentença aberta a transforma em proposição, com valor lógico determinado.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'rlm-b1-02-q1', enunciado: 'A tabela-verdade de uma proposição composta por três proposições simples distintas possui oito linhas.', certa: true, explicacao: 'Aplica-se 2ⁿ, com n = 3 → 8 linhas. Item cobrado na prova de 2022 (que afirmava 16 e estava errado).', variacoes: [{ enunciado: 'A tabela-verdade de uma proposição formada por três proposições simples distintas possui dezesseis linhas.', certa: false, explicacao: '2³ = 8 linhas. Dezesseis linhas corresponderiam a quatro proposições simples.' }] },
        { id: 'rlm-b1-02-q2', enunciado: 'A proposição condicional "se p, então q" é falsa apenas quando p é verdadeira e q é falsa.', certa: true, explicacao: 'É a única linha F da condicional. Antecedente falso torna a condicional verdadeira em qualquer caso.', variacoes: [{ enunciado: 'A proposição condicional é falsa sempre que o antecedente for falso.', certa: false, explicacao: 'Ao contrário: antecedente falso torna a condicional VERDADEIRA.' }] },
        { id: 'rlm-b1-02-q3', enunciado: 'A conjunção "p e q" é verdadeira somente quando ambas as proposições são verdadeiras.', certa: true, explicacao: 'Basta uma ser falsa para a conjunção ser falsa. Já a disjunção só é falsa quando ambas o forem.', variacoes: [{ enunciado: 'Se em uma proposição composta a proposição simples "p" aparece três vezes, ela deve ser contada três vezes no cálculo do número de linhas.', certa: false, explicacao: 'Contam-se apenas as proposições simples DISTINTAS, independentemente do número de ocorrências.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'rlm-b1-03',
      nome: 'Conectivos lógicos e negações',
      teoria: `
## Os conectivos
...
`,
      questoes: [
        { id: 'rlm-b1-03-q1', enunciado: 'A negação da proposição "João estudou e foi aprovado" é "João não estudou ou não foi aprovado".', certa: true, explicacao: 'Aplicação da lei de De Morgan: nega-se cada parte e troca-se a conjunção pela disjunção. Item cobrado na prova de 2022.', variacoes: [{ enunciado: 'A negação de "João estudou e foi aprovado" é "João não estudou e não foi aprovado".', certa: false, explicacao: 'Manter a conjunção é o erro clássico. A negação correta troca "e" por "ou".' }] },
        { id: 'rlm-b1-03-q2', enunciado: 'A negação da proposição "Se chover, então ficarei em casa" é "Choveu e não fiquei em casa".', certa: true, explicacao: '~(p → q) ≡ p ∧ ~q: mantém-se o antecedente e nega-se o consequente. A negação nunca é outra condicional.', variacoes: [{ enunciado: 'A negação de uma proposição condicional é outra proposição condicional com os termos invertidos.', certa: false, explicacao: 'A negação da condicional é uma CONJUNÇÃO (p ∧ ~q), não uma condicional.' }] },
        { id: 'rlm-b1-03-q3', enunciado: 'A proposição "Se estudou, então foi aprovado" é logicamente equivalente a "Se não foi aprovado, então não estudou".', certa: true, explicacao: 'É a contrapositiva (~q → ~p), a equivalência mais cobrada em prova.', variacoes: [{ enunciado: 'A proposição "Se estudou, então foi aprovado" é equivalente a "Se foi aprovado, então estudou".', certa: false, explicacao: 'Essa é a RECÍPROCA, que não é equivalente à original. A equivalente é a contrapositiva.' }] },
        { id: 'rlm-b1-03-q4', enunciado: 'Na proposição "p → q", diz-se que p é condição suficiente para q e que q é condição necessária para p.', certa: true, explicacao: 'O antecedente é suficiente; o consequente é necessário. No bicondicional, ambas são necessárias e suficientes.', variacoes: [{ enunciado: 'As conjunções "mas", "porém" e "contudo" têm valor lógico de disjunção.', certa: false, explicacao: 'Todas têm valor de CONJUNÇÃO (∧), apesar do sentido adversativo.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'rlm-b1-04-q1', enunciado: 'Na proposição "Se me mandou mensagem, meu filho lembrou-se de mim e quer ser lembrado por mim", há três proposições simples distintas.', certa: true, explicacao: 'São elas: "me mandou mensagem", "meu filho lembrou-se de mim" e "quer ser lembrado por mim". Fórmula: p → (q ∧ r). Item da prova de 2022.', variacoes: [{ enunciado: 'A proposição "Se me mandou mensagem, meu filho lembrou-se de mim e quer ser lembrado por mim" contém quatro proposições simples.', certa: false, explicacao: 'São três proposições simples, resultando em tabela-verdade de 8 linhas.' }] },
        { id: 'rlm-b1-04-q2', enunciado: 'Uma proposição composta que assume valor lógico verdadeiro para todas as combinações possíveis de suas proposições simples é denominada tautologia.', certa: true, explicacao: 'Se for sempre falsa, é contradição; se variar, é contingência.', variacoes: [{ enunciado: 'Uma proposição que assume valores lógicos verdadeiro e falso, conforme as combinações, é denominada contradição.', certa: false, explicacao: 'Isso é CONTINGÊNCIA. Contradição é a proposição sempre falsa.' }] },
        { id: 'rlm-b1-04-q3', enunciado: 'Duas proposições são logicamente equivalentes quando o bicondicional formado entre elas é uma tautologia.', certa: true, explicacao: 'Equivale a dizer que possuem tabelas-verdade idênticas.', variacoes: [{ enunciado: 'Na ordem de precedência dos conectivos, a condicional tem prioridade sobre a conjunção.', certa: false, explicacao: 'A ordem é: negação, conjunção, disjunção, condicional e bicondicional. A conjunção precede a condicional.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'rlm-b1-05-q1', enunciado: 'Tautologia é a proposição composta que assume valor lógico verdadeiro para todas as combinações possíveis de valores de suas proposições simples.', certa: true, explicacao: 'Na tabela-verdade, a coluna final é toda V. A negação de uma tautologia é sempre uma contradição.', variacoes: [{ enunciado: 'A proposição "p ∧ ~p" é uma tautologia.', certa: false, explicacao: '"p ∧ ~p" é o exemplo clássico de CONTRADIÇÃO: nunca pode ser verdadeira.' }] },
        { id: 'rlm-b1-05-q2', enunciado: 'A proposição "p ∨ ~p" é uma tautologia, por representar o princípio do terceiro excluído.', certa: true, explicacao: 'Sendo p V ou F, a disjunção com sua negação é sempre verdadeira.', variacoes: [{ enunciado: 'A negação de uma tautologia é outra tautologia.', certa: false, explicacao: 'A negação de uma tautologia é sempre uma CONTRADIÇÃO.' }] },
        { id: 'rlm-b1-05-q3', enunciado: 'Um argumento é válido quando a condicional formada pela conjunção de suas premissas implicando a conclusão constitui uma tautologia.', certa: true, explicacao: 'A validade depende apenas da FORMA do argumento, e não da verdade material das premissas.', variacoes: [{ enunciado: 'Um argumento com premissas falsas jamais pode ser considerado válido.', certa: false, explicacao: 'Validade é questão de forma: um argumento pode ser válido ainda que suas premissas sejam falsas.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'rlm-b1-06-q1', enunciado: 'Se 65% dos servidores gostam de atendimento ao público e, desses, 30% também gostam de trabalhos administrativos, então 19,5% do total gostam das duas modalidades.', certa: true, explicacao: '0,65 × 0,30 = 0,195. O "30%" incide sobre o subconjunto de 65%, não sobre o total. Cálculo cobrado na prova de 2022.', variacoes: [{ enunciado: 'Na situação descrita, mais de 20% do total de servidores gostam das duas modalidades de trabalho.', certa: false, explicacao: 'A interseção é 19,5%, valor inferior a 20%. Item cobrado na prova de 2022.' }] },
        { id: 'rlm-b1-06-q2', enunciado: 'O número de elementos da união de dois conjuntos é igual à soma dos elementos de cada um, subtraído o número de elementos da interseção.', certa: true, explicacao: 'n(A ∪ B) = n(A) + n(B) − n(A ∩ B), evitando a dupla contagem dos elementos comuns.', variacoes: [{ enunciado: 'Um conjunto com cinco elementos possui vinte e cinco subconjuntos.', certa: false, explicacao: 'O número de subconjuntos é 2ⁿ = 2⁵ = 32, e não n².' }] },
        { id: 'rlm-b1-06-q3', enunciado: 'Todo número racional pode ser escrito como quociente de dois inteiros, com denominador diferente de zero.', certa: true, explicacao: 'É a definição de racional. Os irracionais são dízimas não periódicas, como √2 e π.', variacoes: [{ enunciado: 'O conjunto dos números naturais está contido no conjunto dos números inteiros, que por sua vez está contido no dos racionais.', certa: true, explicacao: 'Correto: ℕ ⊂ ℤ ⊂ ℚ ⊂ ℝ.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'rlm-b1-07-q1', enunciado: 'Um valor que sofre aumento de 20% e, em seguida, desconto de 20% retorna ao seu valor original.', certa: false, explicacao: '1,20 × 0,80 = 0,96, ou seja, uma redução líquida de 4%. Percentuais sucessivos se multiplicam, não se somam.', variacoes: [{ enunciado: 'Um valor submetido a dois aumentos sucessivos de 10% sofre aumento total de 21%.', certa: true, explicacao: 'Correto: 1,10 × 1,10 = 1,21 → aumento de 21%.' }] },
        { id: 'rlm-b1-07-q2', enunciado: 'Se 65% dos servidores gostam de atendimento ao público e, desses, 30% também gostam de trabalhos administrativos, a interseção corresponde a 19,5% do total.', certa: true, explicacao: 'A expressão "desses" indica incidência sobre o subconjunto: 0,65 × 0,30 = 0,195. Cálculo da prova de 2022.', variacoes: [{ enunciado: 'Na mesma situação, a interseção corresponde a 30% do total de servidores.', certa: false, explicacao: 'Os 30% incidem sobre os 65%, resultando em 19,5% do total.' }] },
        { id: 'rlm-b1-07-q3', enunciado: 'Em uma prova de 120 questões corrigida com desconto de um ponto por erro, o candidato que acerta 80 e erra 40 obtém nota líquida igual a 40.', certa: true, explicacao: '80 − 40 = 40. O aproveitamento líquido é de 33%, e não dos 67% de acerto bruto — daí a importância de não chutar.', variacoes: [{ enunciado: 'A alíquota progressiva por faixas incide integralmente sobre o valor total da remuneração do segurado.', certa: false, explicacao: 'Cada faixa é tributada pela sua própria alíquota, e os resultados são somados — como no imposto de renda.' }] },
      ],
      flashcards: [
