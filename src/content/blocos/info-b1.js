/**
 * Informática — bloco único
 */
export default {
  id: 'info-b1',
  materiaId: 'info',
  nome: 'Bloco único — Informática',
  ordem: 1,
  objetivo: 'Internet, aplicativos, LibreOffice, Windows, navegação e segurança.',
  topicos: [
    {
      id: 'info-b1-01',
...
`,
      questoes: [
        { id: 'info-b1-01-q1', enunciado: 'A intranet utiliza os mesmos protocolos e tecnologias da internet, diferenciando-se pelo acesso restrito aos membros da organização.', certa: true, explicacao: 'Ambas usam TCP/IP, HTTP e navegadores. A diferença está no alcance e no controle de acesso.', variacoes: [{ enunciado: 'A intranet utiliza protocolos proprietários, incompatíveis com os da internet.', certa: false, explicacao: 'A intranet usa exatamente os mesmos protocolos da internet.' }] },
        { id: 'info-b1-01-q2', enunciado: 'O protocolo IMAP mantém as mensagens armazenadas no servidor, permitindo sincronização entre múltiplos dispositivos, ao contrário do POP3.', certa: true, explicacao: 'O POP3 baixa e, por padrão, remove do servidor; o IMAP sincroniza pastas e status de leitura entre aparelhos.', variacoes: [{ enunciado: 'O protocolo SMTP é utilizado para o recebimento de mensagens de correio eletrônico.', certa: false, explicacao: 'O SMTP é usado para ENVIO. O recebimento é feito por POP3 ou IMAP.' }] },
        { id: 'info-b1-01-q3', enunciado: 'O protocolo HTTPS acrescenta ao HTTP uma camada de criptografia, protegendo os dados trafegados entre o navegador e o servidor.', certa: true, explicacao: 'Usa TLS/SSL na porta 443, garantindo confidencialidade e integridade dos dados em trânsito.', variacoes: [{ enunciado: 'Uma rede virtual privada (VPN) dispensa a criptografia, pois utiliza canais físicos exclusivos.', certa: false, explicacao: 'A VPN cria um túnel CRIPTOGRAFADO sobre a internet pública — não há canal físico exclusivo.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'info-b1-02-q1', enunciado: 'A memória RAM é volátil, perdendo seu conteúdo quando o computador é desligado.', certa: true, explicacao: 'A RAM é a área de trabalho ativa. A ROM é não volátil e armazena o firmware (BIOS/UEFI).', variacoes: [{ enunciado: 'A memória RAM armazena permanentemente os dados do usuário, mesmo após o desligamento.', certa: false, explicacao: 'A RAM é volátil. O armazenamento permanente é feito em HD ou SSD.' }] },
        { id: 'info-b1-02-q2', enunciado: 'Backup diferencial copia todos os arquivos alterados desde o último backup completo, ao passo que o incremental copia apenas o que mudou desde o último backup de qualquer tipo.', certa: true, explicacao: 'Por isso a restauração do diferencial é mais simples: basta o completo mais o último diferencial.', variacoes: [{ enunciado: 'A restauração de um backup incremental exige apenas o último arquivo incremental gerado.', certa: false, explicacao: 'Exige o backup completo E todos os incrementais posteriores, na ordem.' }] },
        { id: 'info-b1-02-q3', enunciado: 'Software livre é aquele que assegura ao usuário as liberdades de executar, estudar, modificar e redistribuir o programa.', certa: true, explicacao: 'Software livre não é sinônimo de gratuito: freeware é gratuito, mas pode ter código fechado.', variacoes: [{ enunciado: 'Todo software gratuito é considerado software livre.', certa: false, explicacao: 'Freeware é gratuito, mas pode ser proprietário. Livre exige as quatro liberdades, inclusive acesso ao código-fonte.' }] },
      ],
      flashcards: [
    ...
    {
      id: 'info-b1-03',
      nome: 'LibreOffice: Writer, Calc e Impress',
      teoria: `
...
`,
      questoes: [
        { id: 'info-b1-03-q1', enunciado: 'No LibreOffice Calc, a fórmula =SOMASE(A1:A7;"auxílio*";B1:B7) soma os valores de B1:B7 cujas células correspondentes em A1:A7 comecem com o texto "auxílio".', certa: true, explicacao: 'O asterisco é curinga para qualquer sequência de caracteres. O ponto de interrogação substitui um único caractere. Função cobrada na prova de 2022.', variacoes: [{ enunciado: 'Na função SOMASE, o caractere "?" substitui qualquer sequência de caracteres no critério de busca.', certa: false, explicacao: 'O "?" substitui UM caractere. Quem substitui qualquer sequência é o "*".' }] },
        { id: 'info-b1-03-q2', enunciado: 'A referência $A$1, ao ser copiada para outras células, mantém-se inalterada, por tratar-se de referência absoluta.', certa: true, explicacao: 'O cifrão fixa a parte que o antecede. Em referências mistas ($A1 ou A$1), fixa-se apenas coluna ou linha.', variacoes: [{ enunciado: 'A referência relativa A1, quando copiada para outra célula, mantém-se inalterada.', certa: false, explicacao: 'Referência relativa AJUSTA linha e coluna ao ser copiada. Quem não muda é a absoluta ($A$1).' }] },
        { id: 'info-b1-03-q3', enunciado: 'A função CONT.NÚM conta apenas as células que contêm valores numéricos, enquanto CONT.VALORES conta todas as células não vazias.', certa: true, explicacao: 'Distinção clássica: CONT.NÚM ignora texto; CONT.VALORES considera qualquer conteúdo.', variacoes: [{ enunciado: 'A extensão nativa de arquivos de planilha do LibreOffice Calc é .xlsx.', certa: false, explicacao: 'A extensão nativa é .ods (ODF). O .xlsx é do Microsoft Excel, embora o Calc consiga abri-lo e salvá-lo.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'info-b1-04-q1', enunciado: 'No Windows 10, a Segurança do Windows verifica continuamente a existência de malwares e vírus e inclui o Microsoft Defender Antivírus.', certa: true, explicacao: 'A Segurança do Windows é a central nativa de proteção e traz o Defender Antivírus embutido, com proteção em tempo real. Item cobrado na prova de 2022.', variacoes: [{ enunciado: 'O Windows 10 não possui antivírus nativo, sendo obrigatória a instalação de solução de terceiros.', certa: false, explicacao: 'O Windows 10 inclui o Microsoft Defender Antivírus, integrado à Segurança do Windows.' }] },
        { id: 'info-b1-04-q2', enunciado: 'Com a finalidade de proteger seus arquivos no Windows 10, o usuário pode criptografá-los pelo aplicativo Windows Defender Firewall, no painel Segurança do Windows.', certa: false, explicacao: 'O firewall filtra tráfego de rede e não criptografa. A criptografia é feita pelo BitLocker (discos) ou pelo EFS (arquivos e pastas). Item cobrado na prova de 2022.', variacoes: [{ enunciado: 'O BitLocker é o recurso do Windows destinado à criptografia de unidades de disco.', certa: true, explicacao: 'Correto. Para arquivos e pastas individuais em NTFS, usa-se o EFS.' }] },
        { id: 'info-b1-04-q3', enunciado: 'O Desfragmentador de Disco reorganiza dados fragmentados no disco rígido, permitindo que ele funcione de maneira mais eficiente.', certa: true, explicacao: 'A desfragmentação vale para HDs mecânicos. Em SSD, o Windows executa o TRIM, e desfragmentar reduziria a vida útil. Item cobrado na prova de 2022.', variacoes: [{ enunciado: 'A desfragmentação periódica é recomendada para unidades SSD, a fim de melhorar seu desempenho.', certa: false, explicacao: 'SSD não deve ser desfragmentado: o Windows usa TRIM, e a desfragmentação reduz a vida útil da unidade.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'info-b1-05-q1', enunciado: 'A navegação privativa impede que o histórico e os cookies sejam salvos no dispositivo, mas não torna o usuário anônimo na internet.', certa: true, explicacao: 'Provedor, empregador e sites visitados continuam podendo identificar o acesso.', variacoes: [{ enunciado: 'A navegação privativa impede que o provedor de acesso identifique os sites visitados pelo usuário.', certa: false, explicacao: 'O provedor continua registrando os acessos. A privacidade é apenas local.' }] },
        { id: 'info-b1-05-q2', enunciado: 'O campo Cco permite enviar cópia da mensagem sem que os demais destinatários tenham conhecimento desse envio.', certa: true, explicacao: 'É o recurso adequado para envios em massa preservando a privacidade dos endereços. Quem está em Cco não aparece no "responder a todos".', variacoes: [{ enunciado: 'Ao utilizar a opção "Responder a todos", os destinatários que constavam do campo Cco também recebem a resposta.', certa: false, explicacao: 'Os destinatários em Cco são ocultos e não são incluídos na resposta a todos.' }] },
        { id: 'info-b1-05-q3', enunciado: 'No Microsoft Outlook, o recurso Sinalizador marca a mensagem para acompanhamento, sem movê-la para a pasta Lixo Eletrônico nem bloquear o remetente.', certa: true, explicacao: 'Sinalizar cria lembrete de acompanhamento. Bloquear remetente é ação distinta, na pasta Lixo Eletrônico. Item cobrado na prova de 2022.', variacoes: [{ enunciado: 'O protocolo HTTPS garante que o site acessado é idôneo e confiável.', certa: false, explicacao: 'O HTTPS garante apenas a criptografia do tráfego. Sites fraudulentos também podem usar HTTPS.' }] },
      ],
      flashcards: [
...
`,
      questoes: [
        { id: 'info-b1-06-q1', enunciado: 'O worm distingue-se do vírus por ser autorreplicante e propagar-se automaticamente pela rede, sem necessidade de hospedeiro.', certa: true, explicacao: 'O vírus precisa de arquivo hospedeiro e de execução pelo usuário; o worm se propaga sozinho, explorando vulnerabilidades da rede.', variacoes: [{ enunciado: 'O cavalo de Troia caracteriza-se por autorreplicar-se e propagar-se automaticamente entre computadores.', certa: false, explicacao: 'O trojan NÃO se autorreplica: disfarça-se de programa legítimo e depende da instalação pelo usuário.' }] },
        { id: 'info-b1-06-q2', enunciado: 'O ransomware criptografa os dados da vítima e exige pagamento de resgate para restaurar o acesso, sendo o backup isolado a principal medida de proteção.', certa: true, explicacao: 'Pagar não garante recuperação. Backup acessível pela mesma rede também é criptografado — por isso deve ser offline ou isolado.', variacoes: [{ enunciado: 'O pagamento do resgate exigido por ransomware garante a recuperação integral dos dados criptografados.', certa: false, explicacao: 'Não há garantia alguma. A defesa efetiva é backup atualizado e isolado.' }] },
        { id: 'info-b1-06-q3', enunciado: 'A assinatura digital garante autenticidade, integridade e não repúdio, mas não assegura a confidencialidade do documento.', certa: true, explicacao: 'A assinatura cifra o hash com a chave privada do autor. Para confidencialidade é preciso cifrar o conteúdo com a chave pública do destinatário.', variacoes: [{ enunciado: 'Na criptografia assimétrica, a mesma chave é utilizada para cifrar e decifrar a mensagem.', certa: false, explicacao: 'Isso é criptografia SIMÉTRICA. A assimétrica usa par de chaves pública e privada.' }] },
        { id: 'info-b1-06-q4', enunciado: 'O ataque de negação de serviço (DoS) compromete principalmente o princípio da disponibilidade da informação.', certa: true, explicacao: 'O DoS/DDoS sobrecarrega o serviço para torná-lo inacessível aos usuários legítimos.', variacoes: [{ enunciado: 'O pharming consiste no envio de mensagens fraudulentas por e-mail que se passam por instituições legítimas.', certa: false, explicacao: 'Isso é PHISHING. O pharming manipula o DNS para redirecionar a um site falso mesmo com o endereço correto.' }] },
      ],
      flashcards: [
